...
%	History:
%		2019-06-25. First edition by Zhenping.
%	Contact:
%		zhenping@tropos.de
...
[att_beta_355, att_beta_532, att_beta_1064] = pollyxt_tjk_att_beta(data, config);
...
if processInfo.flagEnableResultsOutput
    ...
    pollyxt_tjk_save_depolcaliconst(depCaliAttri.depol_cal_fac_355, depCaliAttri.depol_cal_fac_std_355, depCaliAttri.depol_cal_time_355, taskInfo.dataFilename, data.depol_cal_fac_532, data.depol_cal_fac_std_532, fullfile(processInfo.results_folder, campaignInfo.name, config.depolCaliFile355));
