...
saveFolder = 'C:\Users\zhenping\Documents\Data\PollyXT';    % folder which saving the zip files
todoFolder = 'C:\Users\zhenping\Desktop\Picasso\todo_filelist\';
todoListFile = 'C:\Users\zhenping\Desktop\Picasso\todo_filelist\fileinfo_new.txt';

%% search zip files
files = dir(fullfile(saveFolder, instrument, sprintf('%04d%02d', year, month), sprintf('%04d_%02d_%02d*.nc.zip', year, month, day)));
