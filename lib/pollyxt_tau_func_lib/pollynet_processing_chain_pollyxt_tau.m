...
[data.wvconstUsed, data.wvconstUsedStd, data.wvconstUsedInfo] = pollyxt_tau_select_wvconst(wvconst, wvconstStd, data.IWVAttri, polly_parsetime(taskInfo.dataFilename, config.dataFileFormat), fullfile(processInfo.results_folder, campaignInfo.name, config.wvCaliFile), config.flagUsePreviousLC);
...
[att_beta_OC_355, att_beta_OC_532, att_beta_OC_1064, att_beta_OC_387, att_beta_OC_607] = pollyxt_OC_att_beta(data, config);
