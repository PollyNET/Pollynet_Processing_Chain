function [] = pollyxt_tau_save_overlap(data, taskInfo, config, globalAttri, file)
%pollyxt_tau_save_overlap Save the overlap file.
%   Example:
%       [] = pollyxt_tau_save_overlap(data, taskInfo, config, globalAttri, file);
%   Inputs:
%		data: struct
