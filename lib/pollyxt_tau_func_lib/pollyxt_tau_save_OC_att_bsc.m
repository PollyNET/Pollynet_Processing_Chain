function [] = pollyxt_tau_save_OC_att_bsc(data, taskInfo, config)
%pollyxt_tau_save_OC_att_bsc save the attenuated backscatter.
%   Example:
...
varID_att_bsc_355 = netcdf.defVar(ncID, 'OC_attenuated_backscatter_355nm', 'NC_DOUBLE', [dimID_height, dimID_time]);
varID_att_bsc_532 = netcdf.defVar(ncID, 'OC_attenuated_backscatter_532nm', 'NC_DOUBLE', [dimID_height, dimID_time]);
varID_att_bsc_1064 = netcdf.defVar(ncID, 'OC_attenuated_backscatter_1064nm', 'NC_DOUBLE', [dimID_height, dimID_time]);
...
netcdf.putVar(ncID, varID_att_bsc_355, fillmissing(data.att_beta_OC_355, missing_value));
netcdf.putVar(ncID, varID_att_bsc_532, fillmissing(data.att_beta_OC_532, missing_value));
netcdf.putVar(ncID, varID_att_bsc_1064, fillmissing(data.att_beta_OC_1064, missing_value));
