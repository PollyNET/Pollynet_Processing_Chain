function health = pollyxt_tau_read_laserlogbook(file, config, flagDeleteData)
%pollyxt_tau_READ_LASERLOGBOOK read the health parameters of the lidar from 
%the zipped laserlogbook file
%   Usage:
%       health = pollyxt_tau_read_laserlogbook(file)
%   Inputs:
%       file: char
%           the full filename.
%		config: struct
