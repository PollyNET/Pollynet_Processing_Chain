function [cloudFreeSubContGroup] = pollyxt_tau_splitcloudfree(data, config)
%pollyxt_tau_splitcloudfree split the continous cloud free profiles into several small groups.
%   Example:
%       [cloudFreeSubContGroup] = pollyxt_tau_splitcloudfree(data, config)
%   Inputs:
%       data.struct
