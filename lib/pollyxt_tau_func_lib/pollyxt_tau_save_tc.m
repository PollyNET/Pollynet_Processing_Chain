function [] = pollyxt_tau_save_tc(data, taskInfo, config)
%pollyxt_tau_save_tc Saving the target classification results to netcdf file.
%   Example:
%       [] = pollyxt_tau_save_tc(data, config)
%   Inputs:
%       data.struct
