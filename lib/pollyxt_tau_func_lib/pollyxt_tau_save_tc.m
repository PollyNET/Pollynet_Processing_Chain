function [] = apollyxt_tau_save_tc(data, taskInfo, config)
%apollyxt_tau_save_tc Saving the target classification results to netcdf file.
%   Example:
%       [] = apollyxt_tau_save_tc(data, taskInfo, config)
%   Inputs:
%       data.struct
