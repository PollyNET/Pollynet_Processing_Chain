function [] = pollyxt_tau_save_OC_retrieving_results(data, taskInfo, config)
%pollyxt_tau_save_OC_retrieving_results saving the retrieved results, including backscatter, extinction coefficients, lidar ratio, volume/particles depolarization ratio and so on.
%   Example:
...
for iGroup = 1:size(data.cloudFreeGroups, 1)
    ...
    netcdf.putVar(ncID, varID_aerBsc_OC_klett_355, fillmissing(data.aerBsc355_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_klett_532, fillmissing(data.aerBsc532_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_klett_1064, fillmissing(data.aerBsc1064_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_raman_355, fillmissing(data.aerBsc355_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_raman_532, fillmissing(data.aerBsc532_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_raman_1064, fillmissing(data.aerBsc1064_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerExt_OC_raman_355, fillmissing(data.aerExt355_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerExt_OC_raman_532, fillmissing(data.aerExt532_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerExt_OC_raman_1064, fillmissing(data.aerExt1064_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerLR_OC_raman_355, fillmissing(data.LR355_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerLR_OC_raman_532, fillmissing(data.LR532_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerLR_OC_raman_1064, fillmissing(data.LR1064_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_klett_532, fillmissing(data.voldepol532_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_klett_355, fillmissing(data.voldepol355_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_raman_532, fillmissing(data.voldepol532_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_raman_355, fillmissing(data.voldepol355_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_klett_532, fillmissing(data.pardepol532_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_klett_355, fillmissing(data.pardepol355_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_raman_532, fillmissing(data.pardepol532_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_raman_355, fillmissing(data.pardepol355_raman(iGroup, :), missing_value));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_532, 'retrieved_info', sprintf('Smoothing window: %d [m]; molecule depolarization ratio: %7.5f', config.smoothWin_klett_532 * data.hRes, data.moldepol532(iGroup)));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_355, 'retrieved_info', sprintf('Smoothing window: %d [m]; molecule depolarization ratio: %7.5f', config.smoothWin_klett_355 * data.hRes, data.moldepol355(iGroup)));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_532, 'retrieved_info', sprintf('Smoothing window: %d [m]; molecule depolarization ratio: %7.5f', config.smoothWin_raman_532 * data.hRes, data.moldepol532(iGroup)));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_355, 'retrieved_info', sprintf('Smoothing window: %d [m]; molecule depolarization ratio: %7.5f', config.smoothWin_raman_355 * data.hRes, data.moldepol355(iGroup)));
