...
def pollyxt_tau_display_lidarconst(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_tau_display_lidarconst(tmpFile)
...
def main():
    pollyxt_tau_display_lidarconst('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_tau_display_lidarconst(sys.argv[1], sys.argv[2])