function [temp, pres, relh, meteorAttri] = pollyxt_tau_readmeteor(data, config)
%pollyxt_tau_readmeteor Read meteorological data.
%   Example:
%       [temp, pres, relh, meteorAttri] = pollyxt_tau_readmeteor(data, config)
%   Inputs:
%		data: struct
