...
def pollyxt_tau_display_quasiretrieving(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_tau_display_quasiretrieving(tmpFile)
...
def main():
    pollyxt_tau_display_quasiretrieving('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_tau_display_quasiretrieving(sys.argv[1], sys.argv[2])