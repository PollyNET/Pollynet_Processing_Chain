...
def pollyxt_ltaudisplay_quasiretrieving(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_ltaudisplay_quasiretrieving(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyxt_ltaudisplay_quasiretrieving(sys.argv[1], sys.argv[2])