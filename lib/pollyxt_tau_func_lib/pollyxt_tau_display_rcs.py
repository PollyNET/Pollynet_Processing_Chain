...
def pollyxt_noa_display_rcs(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_noa_display_rcs(tmpFile)
...
def main():
    pollyxt_noa_display_rcs('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_noa_display_rcs(sys.argv[1], sys.argv[2])