...
def pollyxt_tau_display_rcs(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_tau_display_rcs(tmpFile)
...
def main():
    pollyxt_tau_display_rcs('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots\\POLLYXT_LACROS\\20180517')

if __name__ == '__main__':
    # main()
    pollyxt_tau_display_rcs(sys.argv[1], sys.argv[2])