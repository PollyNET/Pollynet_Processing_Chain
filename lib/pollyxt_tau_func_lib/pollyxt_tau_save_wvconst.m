function pollyxt_tau_save_wvconst(wvconst, wvconstStd, WVCaliInfo, IWVAttri, dataFilename, wvconstUsed, wvconstStdUsed, file)
%pollyxt_tau_save_wvconst  save the water vapor calibration results. 
%   Example:
%       pollyxt_tau_save_wvconst(wvconst, wvconstStd, WVCaliInfo, IWVAttri, dataFilename, defaults, file)
%   Inputs:
%       wvconst: array
