...
def pollyxt_noa_display_longterm_cali(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_noa_display_longterm_cali(tmpFile)
...
def main():
    pollyxt_noa_display_longterm_cali('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots\\pollyxt_noa\\20181214')

if __name__ == '__main__':
    # main()
    pollyxt_noa_display_longterm_cali(sys.argv[1], sys.argv[2])