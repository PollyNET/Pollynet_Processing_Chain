function health = polly_noa_read_laserlogbook(file, config)
%POLLY_noa_READ_LASERLOGBOOK read the health parameters of the lidar from 
%the zipped laserlogbook file
%   Usage:
%       health = polly_noa_read_laserlogbook(file)
%   Inputs:
%       file: char
%           the full filename.
%		config: struct
