...
def pollyxt_noa_display_WV(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_noa_display_WV(tmpFile)
...
def main():
    pollyxt_noa_display_WV('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots\\POLLYXT_NOA\\20180517')

if __name__ == '__main__':
    # main()
    pollyxt_noa_display_WV(sys.argv[1], sys.argv[2])