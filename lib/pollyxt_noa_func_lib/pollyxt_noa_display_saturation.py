...
def pollyxt_noa_display_saturation(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_noa_display_saturation(tmpFile)
...
def main():
    pollyxt_noa_display_saturation('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_noa_display_saturation(sys.argv[1], sys.argv[2])