function [ data ] = pollyxt_noa_preprocess(data, config)
%pollyxt_noa_preprocess deadtime correction, background correction, 
...
maskDepCalAng = {'none', 'none', 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'none', 'none', 'none', 'n', 'n', 'n', 'n', 'n', 'n', 'n', 'n', 'none'};   % the mask for postive and negative calibration angle. 'none' means invalid profiles with different depol_cal_angle
