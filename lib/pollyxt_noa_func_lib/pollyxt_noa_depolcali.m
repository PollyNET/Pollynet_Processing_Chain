function [data, depCalAttri] = pollyxt_noa_depolcali(data, config, taskInfo, defaults)
%pollyxt_noa_depolcali calibrate the polly depol channels both for 355 and 532 nm with +- 45\deg method.
%	Example:
%		[data] = pollyxt_noa_depolcali(data, config, taskInfo, defaults)
%	Inputs:
%		data: struct
