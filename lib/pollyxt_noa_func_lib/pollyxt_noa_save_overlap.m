function [] = pollyxt_noa_save_overlap(data, config, globalAttri, file)
%pollyxt_noa_save_overlap Save the overlap file.
%   Example:
%       [] = pollyxt_noa_save_overlap(data, overlap532, overlap355, overlap532Defaults, overlap355Defaults, file, config, globalAttri);
%   Inputs:
%		data: struct
