function [aerBsc355_NR_raman, aerBsc532_NR_raman, aerExt355_NR_raman, aerExt532_NR_raman, LR355_NR_raman, LR532_NR_raman, refBeta355_NR_raman, refBeta532_NR_raman] = pollyxt_noa_NR_raman(data, config)
%pollyxt_noa_NR_raman Retrieve aerosol optical properties for near-range channels with raman method
%   Example:
%       [aerBsc355_NR_raman, aerBsc532_NR_raman, aerExt355_NR_raman, aerExt532_NR_raman, LR355_NR_raman, LR532_NR_raman, refBeta355_NR_raman, refBeta532_NR_raman] = pollyxt_noa_NR_raman(data, config)
%   Inputs:
%		data: struct
