function [] = pollyxt_noa_display_depolcali(data, taskInfo, attri)
%pollyxt_noa_display_depolcali display the depolarization calibration results
%   Example:
%       [] = pollyxt_noa_display_depolcali(attri)
%   Inputs:
%       attri
%   Outputs:
%       
...
elseif strcmpi(processInfo.visualizationMode, 'python')
	...
	for iCali = 1:length(attri.depCalAttri532.thisCaliTime)  
	    ...
	    if flag ~= 0
	        warning('Error in executing %s', 'pollyxt_noa_display_depolcali.py');
	    end
