...
for iGroup = 1:size(data.cloudFreeGroups, 1)
    ...
    netcdf.putVar(ncID, varID_aerBsc_klett_355, fillmissing(data.aerBsc355_klett(iGroup, :)));
    netcdf.putVar(ncID, varID_aerBsc_klett_532, fillmissing(data.aerBsc532_klett(iGroup, :)));
    netcdf.putVar(ncID, varID_aerBsc_klett_1064, fillmissing(data.aerBsc1064_klett(iGroup, :)));
    netcdf.putVar(ncID, varID_aerBsc_aeronet_355, fillmissing(data.aerBsc355_aeronet(iGroup, :)));
    netcdf.putVar(ncID, varID_aerBsc_aeronet_532, fillmissing(data.aerBsc532_aeronet(iGroup, :)));
    netcdf.putVar(ncID, varID_aerBsc_aeronet_1064, fillmissing(data.aerBsc1064_aeronet(iGroup, :)));
    netcdf.putVar(ncID, varID_aerBsc_raman_355, fillmissing(data.aerBsc355_raman(iGroup, :)));
    netcdf.putVar(ncID, varID_aerBsc_raman_532, fillmissing(data.aerBsc532_raman(iGroup, :)));
    netcdf.putVar(ncID, varID_aerBsc_raman_1064, fillmissing(data.aerBsc1064_raman(iGroup, :)));
    netcdf.putVar(ncID, varID_aerExt_raman_355, fillmissing(data.aerExt355_raman(iGroup, :)));
    netcdf.putVar(ncID, varID_aerExt_raman_532, fillmissing(data.aerExt532_raman(iGroup, :)));
    netcdf.putVar(ncID, varID_aerExt_raman_1064, fillmissing(data.aerExt1064_raman(iGroup, :)));
