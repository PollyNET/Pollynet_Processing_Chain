function [cloudFreeSubContGroup] = pollyxt_noa_splitcloudfree(data, config)
%pollyxt_noa_splitcloudfree split the continous cloud free profiles into several small groups.
%   Example:
%       [cloudFreeSubContGroup] = pollyxt_noa_splitcloudfree(data, config)
%   Inputs:
%		data: struct
