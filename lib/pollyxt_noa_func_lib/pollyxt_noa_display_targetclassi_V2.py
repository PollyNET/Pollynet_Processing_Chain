...
def pollyxt_noa_display_targetclassi_V2(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_noa_display_targetclassi_V2(tmpFile)
...
def main():
    pollyxt_noa_display_targetclassi_V2('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots\\POLLYXT_NOA\\20180517')

if __name__ == '__main__':
    # main()
    pollyxt_noa_display_targetclassi_V2(sys.argv[1], sys.argv[2])