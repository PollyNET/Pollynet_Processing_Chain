function [] = pollyxt_noa_display_overlap(data, taskInfo, attri, config)
%pollyxt_noa_display_overlap display the overlap function.
%   Example:
%       [] = pollyxt_noa_display_overlap(height, overlap532, overlap355, overlap532Defaults, overlap355Defaults, file, config, campaignInfo)
%   Inputs:
%       height: array
