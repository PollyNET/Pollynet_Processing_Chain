function [LC532, LCStd532, LC607, LCStd607] = polly_first_read_history_LC(thisTime, LCFile, config)
%polly_first_read_history_LC read history Lidar constant from lidar constant file.
%   Example:
%       [LC532, LCStd532, LC607, LCStd607] = polly_first_read_history_LC(thisTime, LCFile, config)
%   Inputs:
%       thisTime: datenum
%           current time. 
%       LCFile: char
