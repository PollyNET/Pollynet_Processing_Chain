function [] = polly_first_save_quasi_results(data, taskInfo, config)
%polly_first_save_quasi_results Saving the target classification results to netcdf file.
%   Example:
%       [] = polly_first_save_quasi_results(data, config)
%   Inputs:
%       data.struct
