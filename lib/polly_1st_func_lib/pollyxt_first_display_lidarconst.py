...
def pollyxt_first_display_lidarconst(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_first_display_lidarconst(tmpFile)
...
def main():
    pollyxt_first_display_lidarconst(
...
if __name__ == '__main__':
    # main()
    pollyxt_first_display_lidarconst(sys.argv[1], sys.argv[2])
