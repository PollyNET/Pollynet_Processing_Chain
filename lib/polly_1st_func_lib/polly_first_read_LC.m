function [LC] = polly_first_read_LC(LCFile, dataFileFormat)
%polly_first_read_LC read the lidar constants from the lidar constant file. Detailed information about the file can be found in /doc/pollynet_processing_program.md
%   Example:
%       [LC] = polly_first_read_LC(LCFile)
%   Inputs:
%       LCFile: char
