function [cloudFreeSubContGroup] = pollyxt_first_splitcloudfree(data, config)
%pollyxt_ift_splitcloudfree split the continous cloud free profiles into several small groups.
%   Example:
%       [cloudFreeSubContGroup] = pollyxt_ift_splitcloudfree(data, config)
%   Inputs:
%       data.struct
