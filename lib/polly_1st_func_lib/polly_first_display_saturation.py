...
def polly_first_display_saturation(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    polly_first_display_saturation(tmpFile)
...
def main():
    polly_first_display_saturation(
...
if __name__ == '__main__':
    # main()
    polly_first_display_saturation(sys.argv[1], sys.argv[2])
