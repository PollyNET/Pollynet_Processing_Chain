function [aerBsc532_aeronet, aerExt532_aeronet, LR532_aeronet, deltaAOD532] = polly_first_constrainedklett(data, AERONET, config)
%polly_first_constrainedklett Retrieve the aerosol optical properties with the constrains from AERONET.
%   Example:
%       [aerBsc532_aeronet, aerExt532_aeronet, LR532_aeronet] = polly_first_constrainedklett(data, AERONET, config)
%   Inputs:
%       data.struct
