...
def pollyxt_first_display_retrieving(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_first_display_retrieving(tmpFile, saveFolder)
...
def main():
    pollyxt_first_display_retrieving(
        'C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat',
        'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots' +
        '\\pollyxt_first\\20180517')


if __name__ == '__main__':
    # main()
    pollyxt_first_display_retrieving(sys.argv[1], sys.argv[2])
