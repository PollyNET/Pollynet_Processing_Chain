...
def polly_first_display_monitor(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    polly_first_display_monitor(tmpFile)
...
if __name__ == '__main__':
    # main()
    polly_first_display_monitor(sys.argv[1], sys.argv[2])
