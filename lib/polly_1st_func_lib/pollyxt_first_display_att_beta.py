...
def pollyxt_first_display_att_beta(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_first_display_att_beta(tmpFile)
...
def main():
    pollyxt_first_display_att_beta(
...
if __name__ == '__main__':
    # main()
    pollyxt_first_display_att_beta(sys.argv[1], sys.argv[2])
