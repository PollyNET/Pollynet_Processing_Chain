function [] = polly_first_save_LC_nc(data, taskInfo, config)
%polly_first_save_LC_nc save the lidar constants.
%   Example:
%   Inputs:
%       data.struct
...
%       2019-08-04. Save the LC_raman_607
...
netcdf.putVar(ncID, varID_LC_warning_607, int32(data.LCUsed.flagLCWarning607));
