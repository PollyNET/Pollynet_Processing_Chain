function [aerBsc532_klett, aerExt532_klett] = polly_first_klett(data, config)
%polly_first_klett Retrieve aerosol optical properties with klett method
%   Example:
%       [aerBsc532_klett, aerExt532_klett] = polly_first_klett(data, config)
%   Inputs:
%       data.struct
