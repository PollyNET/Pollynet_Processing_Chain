function [temp, pres, relh, meteorAttri] = polly_first_readmeteor(data, config)
%polly_ift_readmeteor Read meteorological data.
%   Example:
%       [temp, pres, relh, meteorAttri] = polly_ift_readmeteor(data, config)
%   Inputs:
%       data.struct
