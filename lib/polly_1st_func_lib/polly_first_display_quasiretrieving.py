...
def polly_first_display_quasiretrieving(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    polly_first_display_quasiretrieving(tmpFile)
...
def main():
    polly_first_display_quasiretrieving(
...
if __name__ == '__main__':
    # main()
    polly_first_display_quasiretrieving(sys.argv[1], sys.argv[2])
