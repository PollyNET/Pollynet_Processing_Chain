function [refH532, dpIndx532] = polly_first_rayleighfit(data, config)
%POLLY_FIRST_RAYLEIGHFIT Find the reference height with rayleigh fitting algorithm.
%Example:
%   [rrefH532] = polly_first_rayleighfit(data, config)
%Inputs:
%   data.struct
...
%Outputs:
%   refH532: matrix
%       [[refHBaseIndx532_1, refHTopIndx532_1], [refHBaseIndx532_2, refHTopIndx532_2], ...].
