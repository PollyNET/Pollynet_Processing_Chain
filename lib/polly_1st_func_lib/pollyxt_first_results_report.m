function [reportStr] = pollyxt_first_results_report(data, taskInfo, config)
%pollyxt_first_results_report Write the info to done list file and generate the report for the current task. These report can be used for further examination.
%   Example:
