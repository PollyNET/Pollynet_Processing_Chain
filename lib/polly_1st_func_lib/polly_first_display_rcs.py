...
def polly_first_display_rcs(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    polly_first_display_rcs(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    polly_first_display_rcs(sys.argv[1], sys.argv[2])
