...
netcdf.putVar(ncID, varID_quasi_bsc_355, single(data.qsiBsc355V1));
...
netcdf.putVar(ncID, varID_quasi_bsc_OC_355, single(data.qsiBscOC355V1));
netcdf.putVar(ncID, varID_quasi_bsc_OC_532, single(data.qsiBscOC532V1));
netcdf.putVar(ncID, varID_quasi_bsc_OC_1064, single(data.qsiBscOC1064V1));
netcdf.putVar(ncID, varID_quasi_bsc_NR_355, single(data.qsiBscNR355V1));
netcdf.putVar(ncID, varID_quasi_bsc_NR_532, single(data.qsiBscNR532V1));
