...
ncfile = fullfile(PicassoConfig.results_folder, CampaignConfig.name, datestr(data.mTime(1), 'yyyy'), datestr(data.mTime(1), 'mm'), datestr(data.mTime(1), 'dd'), sprintf('%s_target_classification_V2.nc', rmext(PollyDataInfo.dataFilename)));
...
netcdf.putVar(ncID, varID_tc_mask, data.tcMaskV2);
