...
for iGrp = 1:size(data.clFreGrps, 1)
    ...
    netcdf.putVar(ncID, varID_aerBsc_OC_klett_355, fillmissing(data.aerBsc355_OC_klett(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_klett_532, fillmissing(data.aerBsc532_OC_klett(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_klett_1064, fillmissing(data.aerBsc1064_OC_klett(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_raman_355, fillmissing(data.aerBsc355_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_raman_532, fillmissing(data.aerBsc532_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_raman_1064, fillmissing(data.aerBsc1064_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerExt_OC_raman_355, fillmissing(data.aerExt355_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerExt_OC_raman_532, fillmissing(data.aerExt532_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerExt_OC_raman_1064, fillmissing(data.aerExt1064_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerLR_OC_raman_355, fillmissing(data.LR355_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerLR_OC_raman_532, fillmissing(data.LR532_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_aerLR_OC_raman_1064, fillmissing(data.LR1064_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_klett_532, fillmissing(data.vdr532_klett(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_klett_355, fillmissing(data.vdr355_klett(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_raman_532, fillmissing(data.vdr532_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_raman_355, fillmissing(data.vdr355_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_klett_532, fillmissing(data.pdr532_OC_klett(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_std_klett_532, fillmissing(data.pdrStd532_OC_klett(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_klett_355, fillmissing(data.pdr355_OC_klett(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_std_klett_355, fillmissing(data.pdrStd355_OC_klett(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_raman_532, fillmissing(data.pdr532_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_std_raman_532, fillmissing(data.pdrStd532_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_raman_355, fillmissing(data.pdr355_OC_raman(iGrp, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_std_raman_355, fillmissing(data.pdrStd355_OC_raman(iGrp, :), missing_value));
    ...
    netcdf.putAtt(ncID, varID_volDepol_OC_klett_532, 'retrieved_info', sprintf('Smoothing window: %d [m];', PollyConfig.smoothWin_klett_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_volDepol_OC_klett_355, 'retrieved_info', sprintf('Smoothing window: %d [m];', PollyConfig.smoothWin_klett_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_volDepol_OC_raman_532, 'retrieved_info', sprintf('Smoothing window: %d [m];', PollyConfig.smoothWin_raman_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_volDepol_OC_raman_355, 'retrieved_info', sprintf('Smoothing window: %d [m];', PollyConfig.smoothWin_raman_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_532, 'retrieved_info', sprintf('Smoothing window: %d [m]', PollyConfig.smoothWin_klett_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_std_klett_532, 'retrieving_info', sprintf('Smoothing window: %d [m]', PollyConfig.smoothWin_klett_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_355, 'retrieved_info', sprintf('Smoothing window: %d [m]', PollyConfig.smoothWin_klett_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_std_klett_355, 'retrieving_info', sprintf('Smoothing window: %d [m]', PollyConfig.smoothWin_klett_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_532, 'retrieved_info', sprintf('Smoothing window: %d [m]', PollyConfig.smoothWin_raman_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_std_raman_532, 'retrieving_info', sprintf('Smoothing window: %d [m]', PollyConfig.smoothWin_raman_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_355, 'retrieved_info', sprintf('Smoothing window: %d [m]', PollyConfig.smoothWin_raman_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_std_raman_355, 'retrieving_info', sprintf('Smoothing window: %d [m]', PollyConfig.smoothWin_raman_355 * data.hRes));
