...
for iGrp = 1:size(data.clFreGrps, 1)
    ...
    varID_vdr_klett_532 = netcdf.defVar(ncID, 'vdr_klett_532', 'NC_FLOAT', dimID_height);
    varID_vdrStd_klett_532 = netcdf.defVar(ncID, 'uncertainty_vdr_klett_532', 'NC_FLOAT', dimID_height);
    varID_vdr_klett_355 = netcdf.defVar(ncID, 'vdr_klett_355', 'NC_FLOAT', dimID_height);
    varID_vdrStd_klett_355 = netcdf.defVar(ncID, 'uncertainty_vdr_klett_355', 'NC_FLOAT', dimID_height);
    varID_vdr_raman_532 = netcdf.defVar(ncID, 'vdr_raman_532', 'NC_FLOAT', dimID_height);
    varID_vdrStd_raman_532 = netcdf.defVar(ncID, 'uncertainty_vdr_raman_532', 'NC_FLOAT', dimID_height);
    varID_vdr_raman_355 = netcdf.defVar(ncID, 'vdr_raman_355', 'NC_FLOAT', dimID_height);
    varID_vdrStd_raman_355 = netcdf.defVar(ncID, 'uncertainty_vdr_raman_355', 'NC_FLOAT', dimID_height);
    ...
    varID_pdrStd_klett_532 = netcdf.defVar(ncID, 'uncertainty_pdr_klett_532', 'NC_FLOAT', dimID_height);
    varID_pdrStd_klett_355 = netcdf.defVar(ncID, 'uncertainty_pdr_klett_355', 'NC_FLOAT', dimID_height);
    varID_pdrStd_raman_532 = netcdf.defVar(ncID, 'uncertainty_pdr_raman_532', 'NC_FLOAT', dimID_height);
    varID_pdrStd_raman_355 = netcdf.defVar(ncID, 'uncertainty_pdr_raman_355', 'NC_FLOAT', dimID_height);
