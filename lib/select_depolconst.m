function [dcUsed, dcUsedStd, dcUsedStartTime, dcUsedStopTime] = ...
    select_depolconst(depolconst, depolconstStd, depolCaliStartTime, ...
        depolCaliStopTime, queryTime, dbFile, pollyType, wavelength, varargin)
%SELECT_DEPOLCONST select most suitable depol calibration constant.
%Example:
%   [dcUsed, dcUsedStd, dcUsedStartTime, dcUsedStopTime] =
%       select_depolconst(depolconst, depolconstStd, depolCaliTime,
