function pollyxt_save_quasi_results(data, taskInfo, config)
%POLLYXT_SAVE_QUASI_RESULTS Saving the target classification results to netcdf file.
%Example:
%   pollyxt_save_quasi_results(data, config)
%Inputs:
%   data.struct
...
netcdf.putAtt(ncID, varID_quasi_bsc_532, 'Lidar_ratio_used', config.LR532);
...
netcdf.putAtt(ncID, varID_quasi_bsc_1064, 'Lidar_ratio_used', config.LR1064);
