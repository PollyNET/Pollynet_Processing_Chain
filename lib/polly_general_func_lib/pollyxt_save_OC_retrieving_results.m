function pollyxt_save_OC_retrieving_results(data, taskInfo, config)
%POLLYXT_SAVE_OC_RETRIEVING_RESULTS saving the retrieved results, including backscatter, extinction coefficients, lidar ratio, volume/particles depolarization ratio and so on.
%Example:
...
%       More detailed information can be found in doc/pollynet_processing_program.md
%History:
%   2019-11-27. Turn on the netCDF4 compression.
%Contact:
%   zhenping@tropos.de
...
for iGroup = 1:size(data.cloudFreeGroups, 1)
    ncFile = fullfile(processInfo.results_folder, campaignInfo.name, datestr(data.mTime(1), 'yyyy'), datestr(data.mTime(1), 'mm'), datestr(data.mTime(1), 'dd'), sprintf('%s_%s_%s_OC_profiles.nc', rmext(taskInfo.dataFilename), datestr(data.mTime(data.cloudFreeGroups(iGroup, 1)), 'HHMM'), datestr(data.mTime(data.cloudFreeGroups(iGroup, 2)), 'HHMM')));
    ...
    varID_aerBsc_OC_klett_355 = netcdf.defVar(ncID, 'aerBsc_OC_klett_355', 'NC_DOUBLE', dimID_height);
    varID_aerBsc_OC_klett_532 = netcdf.defVar(ncID, 'aerBsc_OC_klett_532', 'NC_DOUBLE', dimID_height);
    varID_aerBsc_OC_klett_1064 = netcdf.defVar(ncID, 'aerBsc_OC_klett_1064', 'NC_DOUBLE', dimID_height);
    varID_aerBsc_OC_raman_355 = netcdf.defVar(ncID, 'aerBsc_OC_raman_355', 'NC_DOUBLE', dimID_height);
    varID_aerBsc_OC_raman_532 = netcdf.defVar(ncID, 'aerBsc_OC_raman_532', 'NC_DOUBLE', dimID_height);
    varID_aerBsc_OC_raman_1064 = netcdf.defVar(ncID, 'aerBsc_OC_raman_1064', 'NC_DOUBLE', dimID_height);
    varID_aerExt_OC_raman_355 = netcdf.defVar(ncID, 'aerExt_OC_raman_355', 'NC_DOUBLE', dimID_height);
    varID_aerExt_OC_raman_532 = netcdf.defVar(ncID, 'aerExt_OC_raman_532', 'NC_DOUBLE', dimID_height);
    varID_aerExt_OC_raman_1064 = netcdf.defVar(ncID, 'aerExt_OC_raman_1064', 'NC_DOUBLE', dimID_height);
    varID_aerLR_OC_raman_355 = netcdf.defVar(ncID, 'aerLR_OC_raman_355', 'NC_DOUBLE', dimID_height);
    varID_aerLR_OC_raman_532 = netcdf.defVar(ncID, 'aerLR_OC_raman_532', 'NC_DOUBLE', dimID_height);
    varID_aerLR_OC_raman_1064 = netcdf.defVar(ncID, 'aerLR_OC_raman_1064', 'NC_DOUBLE', dimID_height);
    varID_volDepol_OC_klett_532 = netcdf.defVar(ncID, 'volDepol_OC_klett_532', 'NC_DOUBLE', dimID_height);
    varID_volDepol_OC_klett_355 = netcdf.defVar(ncID, 'volDepol_OC_klett_355', 'NC_DOUBLE', dimID_height);
    varID_volDepol_OC_raman_532 = netcdf.defVar(ncID, 'volDepol_OC_raman_532', 'NC_DOUBLE', dimID_height);
    varID_volDepol_OC_raman_355 = netcdf.defVar(ncID, 'volDepol_OC_raman_355', 'NC_DOUBLE', dimID_height);
    varID_parDepol_OC_klett_532 = netcdf.defVar(ncID, 'parDepol_OC_klett_532', 'NC_DOUBLE', dimID_height);
    varID_parDepol_OC_klett_355 = netcdf.defVar(ncID, 'parDepol_OC_klett_355', 'NC_DOUBLE', dimID_height);
    varID_parDepol_OC_raman_532 = netcdf.defVar(ncID, 'parDepol_OC_raman_532', 'NC_DOUBLE', dimID_height);
    varID_parDepol_OC_raman_355 = netcdf.defVar(ncID, 'parDepol_OC_raman_355', 'NC_DOUBLE', dimID_height);
    varID_parDepol_OC_std_klett_532 = netcdf.defVar(ncID, 'uncertainty_parDepol_OC_klett_532', 'NC_DOUBLE', dimID_height);
    varID_parDepol_OC_std_klett_355 = netcdf.defVar(ncID, 'uncertainty_parDepol_OC_klett_355', 'NC_DOUBLE', dimID_height);
    varID_parDepol_OC_std_raman_532 = netcdf.defVar(ncID, 'uncertainty_parDepol_OC_raman_532', 'NC_DOUBLE', dimID_height);
    varID_parDepol_OC_std_raman_355 = netcdf.defVar(ncID, 'uncertainty_parDepol_OC_raman_355', 'NC_DOUBLE', dimID_height);
    ...
    netcdf.putVar(ncID, varID_aerBsc_OC_klett_355, fillmissing(data.aerBsc355_OC_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_klett_532, fillmissing(data.aerBsc532_OC_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_klett_1064, fillmissing(data.aerBsc1064_OC_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_raman_355, fillmissing(data.aerBsc355_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_raman_532, fillmissing(data.aerBsc532_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerBsc_OC_raman_1064, fillmissing(data.aerBsc1064_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerExt_OC_raman_355, fillmissing(data.aerExt355_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerExt_OC_raman_532, fillmissing(data.aerExt532_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerExt_OC_raman_1064, fillmissing(data.aerExt1064_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerLR_OC_raman_355, fillmissing(data.LR355_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerLR_OC_raman_532, fillmissing(data.LR532_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_aerLR_OC_raman_1064, fillmissing(data.LR1064_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_klett_532, fillmissing(data.voldepol532_OC_klett(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_volDepol_OC_klett_355, fillmissing(data.voldepol355_OC_klett(iGroup, :), missing_value));
    ...
    netcdf.putVar(ncID, varID_parDepol_OC_std_raman_532, fillmissing(data.pardepolStd532_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_raman_355, fillmissing(data.pardepol355_OC_raman(iGroup, :), missing_value));
    netcdf.putVar(ncID, varID_parDepol_OC_std_raman_355, fillmissing(data.pardepolStd355_OC_raman(iGroup, :), missing_value));
    ...
    netcdf.putAtt(ncID, varID_volDepol_OC_klett_532, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_volDepol_OC_klett_532, 'retrieved_info', sprintf('Smoothing window: %d [m];', config.smoothWin_klett_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_volDepol_OC_klett_355, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_volDepol_OC_klett_355, 'retrieved_info', sprintf('Smoothing window: %d [m];', config.smoothWin_klett_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_volDepol_OC_raman_532, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_volDepol_OC_raman_532, 'retrieved_info', sprintf('Smoothing window: %d [m];', config.smoothWin_raman_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_volDepol_OC_raman_355, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_volDepol_OC_raman_355, 'retrieved_info', sprintf('Smoothing window: %d [m];', config.smoothWin_raman_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_532, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_532, 'molecular_depolarization_ratio', data.moldepol532(iGroup));
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_532, 'retrieved_info', sprintf('Smoothing window: %d [m]', config.smoothWin_klett_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_std_klett_532, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_parDepol_OC_std_klett_532, 'molecular_depolarization_ratio', data.moldepol532(iGroup));
    netcdf.putAtt(ncID, varID_parDepol_OC_std_klett_532, 'retrieving_info', sprintf('Smoothing window: %d [m]', config.smoothWin_klett_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_355, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_355, 'molecular_depolarization_ratio', data.moldepol532(iGroup));
    netcdf.putAtt(ncID, varID_parDepol_OC_klett_355, 'retrieved_info', sprintf('Smoothing window: %d [m]', config.smoothWin_klett_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_std_klett_355, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_parDepol_OC_std_klett_355, 'molecular_depolarization_ratio', data.moldepol355(iGroup));
    netcdf.putAtt(ncID, varID_parDepol_OC_std_klett_355, 'retrieving_info', sprintf('Smoothing window: %d [m]', config.smoothWin_klett_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_532, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_532, 'molecular_depolarization_ratio', data.moldepol532(iGroup));
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_532, 'retrieved_info', sprintf('Smoothing window: %d [m]', config.smoothWin_raman_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_std_raman_532, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_parDepol_OC_std_raman_532, 'molecular_depolarization_ratio', data.moldepol532(iGroup));
    netcdf.putAtt(ncID, varID_parDepol_OC_std_raman_532, 'retrieving_info', sprintf('Smoothing window: %d [m]', config.smoothWin_raman_532 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_355, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_355, 'molecular_depolarization_ratio', data.moldepol355(iGroup));
    netcdf.putAtt(ncID, varID_parDepol_OC_raman_355, 'retrieved_info', sprintf('Smoothing window: %d [m]', config.smoothWin_raman_355 * data.hRes));
    ...
    netcdf.putAtt(ncID, varID_parDepol_OC_std_raman_355, 'source', campaignInfo.name);
    netcdf.putAtt(ncID, varID_parDepol_OC_std_raman_355, 'molecular_depolarization_ratio', data.moldepol355(iGroup));
    netcdf.putAtt(ncID, varID_parDepol_OC_std_raman_355, 'retrieving_info', sprintf('Smoothing window: %d [m]', config.smoothWin_raman_355 * data.hRes));
