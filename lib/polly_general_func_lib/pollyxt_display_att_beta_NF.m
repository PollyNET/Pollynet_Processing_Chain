function pollyxt_display_att_beta_NF(data, taskInfo, config)
...
ATT_BETA_532 = datt_beta_NR_532;

quality_mask_NR_355 = data.quality_mask_NR_355;
quality_mask_NR_532 = data.quality_mask_NR_532;
quality_mask_NR_1064 = data.quality_mask_NR_1064;
height = data.height;
time = data.mTime;
