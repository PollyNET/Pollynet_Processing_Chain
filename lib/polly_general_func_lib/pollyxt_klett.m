function [aerBsc355_klett, aerBsc532_klett, aerBsc1064_klett, aerExt355_klett, aerExt532_klett, aerExt1064_klett] = pollyxt_klett(data, config)
%pollyxt_klett Retrieve aerosol optical properties with klett method
%   Example:
%       [aerBsc355_klett, aerBsc532_klett, aerBsc1064_klett, aerExt355_klett, aerExt532_klett, aerExt1064_klett] = pollyxt_klett(data, config)
%   Inputs:
%       data.struct
