...
def pollyxt_display_longterm_cali(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_display_longterm_cali(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyxt_display_longterm_cali(sys.argv[1], sys.argv[2])
