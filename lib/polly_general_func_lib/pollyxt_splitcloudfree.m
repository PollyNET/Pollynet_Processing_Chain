function [cloudFreeSubContGroup] = pollyxt_splitcloudfree(data, config)
%POLLYXT_SPLITCLOUDFREE split the continous cloud free profiles into several small groups.
%Example:
%   [cloudFreeSubContGroup] = pollyxt_splitcloudfree(data, config)
%Inputs:
%   data.struct
