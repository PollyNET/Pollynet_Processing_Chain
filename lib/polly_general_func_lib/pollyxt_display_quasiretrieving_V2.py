...
def pollyxt_display_quasiretrieving_V2(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_display_quasiretrieving_V2(tmpFile, saveFolder)
...
def main():
    pollyxt_display_quasiretrieving_V2(
...
if __name__ == '__main__':
    # main()
    pollyxt_display_quasiretrieving_V2(sys.argv[1], sys.argv[2])
