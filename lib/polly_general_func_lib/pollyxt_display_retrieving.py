...
def pollyxt_display_retrieving(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_display_retrieving(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyxt_display_retrieving(sys.argv[1], sys.argv[2])
