...
def pollyxt_display_targetclassi(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_display_targetclassi(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyxt_display_targetclassi(sys.argv[1], sys.argv[2])
