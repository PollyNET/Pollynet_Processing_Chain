function [quasi_par_bsc_355, quasi_par_bsc_532, quasi_par_bsc_1064, ...
          ...
          quality_mask_volDepol_532, quasiAttri] = pollyxt_quasiretrieve(data, config)
%pollyxt_quasiretrieve Retrieving the intensive aerosol optical properties with
...
%        quality_mask_volDepol_532] = pollyxt_quasiretrieve(data, config)
%   Inputs:
%       data.struct
