function [wvconst, wvconstStd, globalAttri] = pollyxt_wv_calibration(data, config)
%POLLYXT_WV_CALIBRATION water vapor calibration. 
%Example:
%   [wvconst, wvconstStd, globalAttri] = pollyxt_wv_calibration(data, config)
%Inputs:
%   data: struct
