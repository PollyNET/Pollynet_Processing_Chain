function [IWV, globalAttri] = pollyxt_read_IWV(data, config)
%POLLYXT_READ_IWV read integrated water vapor from external instruments, like
%sunphotometer or microwave radiometer.
%Example:
%   [IWV, globalAttri] = pollyxt_read_IWV(data, config)
%Inputs:
%   data.struct
