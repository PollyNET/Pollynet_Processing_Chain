function [temp, pres, relh, meteorAttri] = pollyxt_readmeteor(data, config)
%POLLYXT_READMETEOR Read meteorological data.
%   Example:
%       [temp, pres, relh, meteorAttri] = pollyxt_readmeteor(data, config)
%   Inputs:
%       data.struct
