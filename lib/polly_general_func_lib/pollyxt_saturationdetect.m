function [flag] = pollyxt_saturationdetect(data, config)
%POLLYXT_SATURATIONDETECT detect the bins which is fully saturated by the
%clouds.
%Example:
%   [flag] = pollyxt_saturationdetect(data, height, config)
%Inputs:
%   data: struct
