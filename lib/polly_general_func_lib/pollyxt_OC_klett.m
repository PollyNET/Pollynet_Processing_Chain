function [aerBsc355_klett, aerBsc532_klett, aerBsc1064_klett, aerExt355_klett, aerExt532_klett, aerExt1064_klett] = pollyxt_OC_klett(data, config)
%POLLYXT_OC_KLETT Retrieve aerosol optical properties for overlap correction far-range signal with klett method
%Example:
%   [aerBsc355_klett, aerBsc532_klett, aerBsc1064_klett, aerExt355_klett, aerExt532_klett, aerExt1064_klett] = pollyxt_OC_klett(data, config)
%Inputs:
%   data.struct
