...
def pollyxt_display_quasiretrieving(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_display_quasiretrieving(tmpFile, saveFolder)
...
def main():
    pollyxt_display_quasiretrieving(
...
if __name__ == '__main__':
    # main()
    pollyxt_display_quasiretrieving(sys.argv[1], sys.argv[2])
