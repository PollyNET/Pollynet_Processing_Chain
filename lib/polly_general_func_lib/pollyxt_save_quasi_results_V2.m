function pollyxt_save_quasi_results_V2(data, taskInfo, config)
%POLLYXT_SAVE_QUASI_RESULTS_V2 Saving the quasi retrieving results (V2) to netcdf file.
%Example:
%   pollyxt_save_quasi_results_V2(data, config)
%Inputs:
%   data.struct
