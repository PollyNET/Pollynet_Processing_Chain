...
%    flagCloudFree = cloudScreen(time, height, signal, 'mode', 1, 'detectRange', [0, 8000], 'slope_thres', 1e7)
%
%    % Usecase 3: cloudscreen with using Zhao's algorithm
%    [flagCloudFree, layerStatus] = cloudScreen(time, height, signal, 'mode', 2, 'minDepth', 500);
%
% INPUTS:
%    time: array
