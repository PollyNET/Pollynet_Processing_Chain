function [] = pollyxt_fmi_save_quasi_results(data, taskInfo, config)
%pollyxt_fmi_save_quasi_results Saving the target classification results to netcdf file.
%   Example:
%       [] = pollyxt_fmi_save_quasi_results(data, config)
%   Inputs:
%		data: struct
