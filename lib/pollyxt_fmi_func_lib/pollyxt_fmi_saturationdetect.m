function [flag] = pollyxt_fmi_saturationdetect(data, config)
%pollyxt_fmi_saturationdetect detect the bins which is fully saturated by the clouds. The description about the detection algorithm can be found in doc/polly_defaults.md
%   Example:
%       [flag] = pollyxt_fmi_saturationdetect(data, height, config)
%   Inputs:
%       data: struct
