...
def pollyxt_fmi_display_lidarconst(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_fmi_display_lidarconst(tmpFile)
...
def main():
    pollyxt_fmi_display_lidarconst('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_fmi_display_lidarconst(sys.argv[1], sys.argv[2])