...
def pollyxt_fmi_display_quasiretrieving_V2(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_fmi_display_quasiretrieving_V2(tmpFile)
...
def main():
    pollyxt_fmi_display_quasiretrieving_V2('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_fmi_display_quasiretrieving_V2(sys.argv[1], sys.argv[2])