function [] = pollyxt_fmi_save_quasi_results_V2(data, taskInfo, config)
%pollyxt_fmi_save_quasi_results_V2 Saving the quasi retrieving results (V2) to netcdf file.
%   Example:
%       [] = pollyxt_fmi_save_quasi_results_V2(data, config)
%   Inputs:
%       data.struct
