...
def pollyxt_fmi_display_att_beta(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_fmi_display_att_beta(tmpFile)
...
def main():
    pollyxt_fmi_display_att_beta('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots\\POLLYXT_FMI\\20180517')

if __name__ == '__main__':
    # main()
    pollyxt_fmi_display_att_beta(sys.argv[1], sys.argv[2])