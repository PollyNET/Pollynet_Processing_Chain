function [ang_ext_355_532_raman, ang_bsc_355_532_raman, ang_bsc_355_532_klett] = pollyxt_fmi_NR_angstrexp(data, config)
%pollyxt_fmi_NR_angstrexp Retrieve the angstroem exponent with klett-retrieve and raman-retrieved aerosol optical properties.
%   Example:
%       [ang_ext_355_532_raman, ang_bsc_355_532_raman, ang_bsc_355_532_klett] = pollyxt_fmi_NR_angstrexp(data, config)
%   Inputs:
%		data: struct
