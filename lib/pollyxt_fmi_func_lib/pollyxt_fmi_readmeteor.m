function [temp, pres, relh, meteorAttri] = pollyxt_fmi_readmeteor(data, config)
%pollyxt_fmi_readmeteor Read meteorological data.
%   Example:
%       [temp, pres, relh, meteorAttri] = pollyxt_fmi_readmeteor(data, config)
%   Inputs:
%       data.struct
