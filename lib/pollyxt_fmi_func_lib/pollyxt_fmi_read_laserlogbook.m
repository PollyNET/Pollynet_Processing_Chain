function health = pollyxt_fmi_read_laserlogbook(file, config, flagDeleteData)
%pollyxt_fmi_READ_LASERLOGBOOK read the health parameters of the lidar from 
%the zipped laserlogbook file
%   Usage:
%       health = pollyxt_fmi_read_laserlogbook(file)
%   Inputs:
%       file: char
%           the full filename.
%		config: struct
