function [] = pollyxt_fmi_save_overlap(data, taskInfo, config, globalAttri, file)
%pollyxt_fmi_save_overlap Save the overlap file.
%   Example:
%       [] = pollyxt_fmi_save_overlap(data, taskInfo, config, globalAttri, file);
%   Inputs:
%		data: struct
