function [cloudFreeSubContGroup] = pollyxt_fmi_splitcloudfree(data, config)
%pollyxt_fmi_splitcloudfree split the continous cloud free profiles into several small groups.
%   Example:
%       [cloudFreeSubContGroup] = pollyxt_fmi_splitcloudfree(data, config)
%   Inputs:
%       data.struct
