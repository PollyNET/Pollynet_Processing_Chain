...
def pollyxt_fmi_display_monitor(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_fmi_display_monitor(tmpFile)
...
def main():
    pollyxt_fmi_display_monitor('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots\\POLLYXT_fmi\\20180517')

if __name__ == '__main__':
    # main()
    pollyxt_fmi_display_monitor(sys.argv[1], sys.argv[2])