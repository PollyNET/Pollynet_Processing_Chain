function [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = pollyxt_fmi_save_wvconst(wvconst, wvconstStd, WVCaliInfo, IWVAttri, dataFilename, defaults, file)
%pollyxt_fmi_save_wvconst  save the water vapor calibration results. And select the most appropriate water vapor calibration constant to calculate the WVMR and RH.
%   Example:
%       [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = pollyxt_fmi_save_wvconst(wvconst, wvconstStd, WVCaliInfo, IWVAttri, dataFilename, defaults, file)
%   Inputs:
%       wvconst: array
