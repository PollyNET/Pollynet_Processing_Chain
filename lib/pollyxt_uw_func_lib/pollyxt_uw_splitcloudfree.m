function [cloudFreeSubContGroup] = pollyxt_uw_splitcloudfree(data, config)
%pollyxt_uw_splitcloudfree split the continous cloud free profiles into several small groups.
%   Example:
%       [cloudFreeSubContGroup] = pollyxt_uw_splitcloudfree(data, config)
%   Inputs:
%       data.struct
