function [LCUsed355, LCUsedTag355, flagLCWarning355, LCUsed532, LCUsedTag532, flagLCWarning532, LCUsed1064, LCUsedTag1064, flagLCWarning1064, LCUsed387, LCUsedTag387, flagLCWarning387, LCUsed607, LCUsedTag607, flagLCWarning607] = pollyxt_uw_mean_LC(data, config, taskInfo, folder)
%pollyxt_uw_mean_LC calculate and save the lidar calibration constant based on the optional constants and defaults.
%   Example:
%       [LCUsed355, LCUsedTag355, flagLCWarning355, LCUsed532, LCUsedTag532, flagLCWarning532, LCUsed1064, LCUsedTag1064, flagLCWarning1064, LCUsed387, LCUsedTag387, flagLCWarning387, LCUsed607, LCUsedTag607, flagLCWarning607] = pollyxt_uw_mean_LC(data, config)
%   Inputs:
%       data.struct
...
[LC355History, LC532History, LC1064History, LC387History, LC607History, LCStd355History, LCStd532History, LCStd1064History, LCStd387History, LCStd607History] = pollyxt_uw_read_history_LC(taskInfo.dataTime, LCCaliFile, config);
