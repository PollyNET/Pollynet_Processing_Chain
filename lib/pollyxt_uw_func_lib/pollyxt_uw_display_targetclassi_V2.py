...
def pollyxt_uw_display_targetclassi(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_uw_display_targetclassi(tmpFile)
...
def main():
    pollyxt_uw_display_targetclassi('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_uw_display_targetclassi(sys.argv[1], sys.argv[2])