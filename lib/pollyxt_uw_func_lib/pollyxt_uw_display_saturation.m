function [] = pollyxt_uw_display_saturation(data, taskInfo, config)
%pollyxt_uw_display_saturation display the saturation mask.
%   Example:
...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    if flag ~= 0
        warning('Error in executing %s', 'pollyxt_uw_display_saturation.py');
    end
