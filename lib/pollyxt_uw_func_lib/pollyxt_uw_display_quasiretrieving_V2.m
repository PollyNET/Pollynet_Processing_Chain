function [] = pollyxt_uw_display_quasiretrieving_V2(data, taskInfo, config)
%pollyxt_uw_display_quasiretrieving_V2 display the quasi retrievings results
%   Example:
...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    if flag ~= 0
        warning('Error in executing %s', 'pollyxt_uw_display_quasiretrieving_V2.py');
    end
