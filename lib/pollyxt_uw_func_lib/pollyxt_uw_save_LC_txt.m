function [] = pollyxt_uw_save_LC_txt(data, taskInfo, config)
%pollyxt_uw_save_LC_txt  save the lidar constants
%   Example:
%       [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = pollyxt_uw_save_LC_txt(data, taskInfo, config)
%   Inputs:
%       wvconst: array
