function [wvconst, wvconstStd] = pollyxt_uw_search_wvconst(currentTime, file, deltaTime, defaults)
%pollyxt_uw_search_wvconst Search the previous calibration constants with a time lag less than deltaTime.
%   Example:
%       [wvconst, wvconstStd] = pollyxt_uw_search_wvconst(currentTime, file, deltaTime, defaults)
%   Inputs:
%       currentTime: datenum
...
[preWVlCaliTime, preWVconst, preWVconstStd] = pollyxt_uw_read_wvconst(file);
