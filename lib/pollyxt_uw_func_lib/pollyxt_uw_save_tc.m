function [] = pollyxt_uw_save_tc(data, taskInfo, config)
%pollyxt_uw_save_tc Saving the target classification results to netcdf file.
%   Example:
%       [] = pollyxt_uw_save_tc(data, config)
%   Inputs:
%		data: struct
