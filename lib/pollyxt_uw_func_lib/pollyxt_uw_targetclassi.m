function [tc_mask] = pollyxt_uw_targetclassi(data, config)
%pollyxt_uw_targetclassi Aerosol target classification based on algorithms presented in H.Baar et al, 2017, ATM.
%   Example:
