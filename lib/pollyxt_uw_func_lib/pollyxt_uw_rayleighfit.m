function [refH355, refH532, refH1064, dpIndx355, dpIndx532, dpIndx1064] = pollyxt_uw_rayleighfit(data, config)
%pollyxt_uw_rayleighfit Find the reference height with rayleigh fitting algorithm.
%   Example:
%       [refH355, refH532, refH1064] = pollyxt_uw_rayleighfit(data, config)
%   Inputs:
%		data: struct
