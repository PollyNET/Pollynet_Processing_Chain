function [] = pollyxt_uw_display_lidarconst(data, taskInfo, config)
%pollyxt_uw_display_lidarconst Display the lidar constants.
%   Example:
...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    if flag ~= 0
        warning('Error in executing %s', 'pollyxt_uw_display_lidarconst.py');
    end
    delete(tmpFile);
