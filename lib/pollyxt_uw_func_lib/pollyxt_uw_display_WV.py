...
def pollyxt_uw_display_WV(tmpFile, saveFolder):
    '''
    Description
    -----------
...
def main():
    pollyxt_uw_display_WV('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_uw_display_WV(sys.argv[1], sys.argv[2])