function [] = pollyxt_uw_save_overlap(height, config, globalAttri, file)
%pollyxt_uw_save_overlap Save the overlap file.
%   Example:
%       [] = pollyxt_uw_save_overlap(height, overlap532, overlap355, overlap532Defaults, overlap355Defaults, file, config, globalAttri);
%   Inputs:
%       height: array
