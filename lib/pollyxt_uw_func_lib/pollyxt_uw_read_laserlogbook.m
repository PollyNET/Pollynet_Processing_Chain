function health = polly_uw_read_laserlogbook(file, config)
%POLLY_uw_READ_LASERLOGBOOK read the health parameters of the lidar from 
%the zipped laserlogbook file
%   Usage:
%       health = polly_uw_read_laserlogbook(file)
%   Inputs:
%       file: char
%           the full filename.
%		config: struct
