...
def pollyxt_luwdisplay_quasiretrieving_V2(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_luwdisplay_quasiretrieving_V2(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyxt_luwdisplay_quasiretrieving_V2(sys.argv[1], sys.argv[2])