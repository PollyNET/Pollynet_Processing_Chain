function [temp, pres, relh, meteorAttri] = pollyxt_uw_readmeteor(data, config)
%pollyxt_uw_readmeteor Read meteorological data.
%   Example:
%       [temp, pres, relh, meteorAttri] = pollyx_uw_readmeteor(data, config)
%   Inputs:
%		data: struct
