function [datetime, depolconst, depolconstStd] = pollyxt_uw_read_depolconst(depolconstFile)
%pollyxt_uw_read_depolconst read the depolarization calibration results from the file.
%   Example:
%       [datetime, depolconst, depolconstStd] = pollyxt_uw_read_depolconst(depolconstFile)
%   Inputs:
%       depolconstFile: char
