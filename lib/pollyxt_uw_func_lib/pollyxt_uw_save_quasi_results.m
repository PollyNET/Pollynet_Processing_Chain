function [] = pollyxt_uw_save_quasi_results(data, taskInfo, config)
%pollyxt_uw_save_quasi_results Saving the target classification results to netcdf file.
%   Example:
%       [] = pollyxt_uw_save_quasi_results(data, config)
%   Inputs:
%		data: struct
