function [] = pollyxt_tjk_save_depolcaliconst(depolConst, depolConstStd, depolCaliTime, dataFilename, depol_cal_fac, depol_cal_fac_std, file)
%pollyxt_tjk_save_depolcaliconst save the depolarization calibration results.
%   Example:
%       [] = pollyxt_tjk_save_depolcaliconst(depolConst, depolConstStd, depolCaliTime, dataFilename, defaults, file)
%   Inputs:
%       depolConst: array
