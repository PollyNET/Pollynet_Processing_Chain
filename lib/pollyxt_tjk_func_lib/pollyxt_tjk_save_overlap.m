function [] = pollyxt_tjk_save_overlap(data, taskInfo, config, globalAttri, file)
%pollyxt_tjk_save_overlap Save the overlap file.
%   Example:
%       [] = pollyxt_tjk_save_overlap(data, taskInfo, config, globalAttri, file);
%   Inputs:
%		data: struct
