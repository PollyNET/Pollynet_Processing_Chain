...
def pollyxt_tjk_display_monitor(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_tjk_display_monitor(tmpFile)
...
def main():
    pollyxt_tjk_display_monitor('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_tjk_display_monitor(sys.argv[1], sys.argv[2])