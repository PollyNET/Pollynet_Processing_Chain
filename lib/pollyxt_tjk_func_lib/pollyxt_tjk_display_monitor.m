function [] = pollyxt_tjk_display_monitor(data, taskInfo, config)
%pollyxt_tjk_display_monitor display the values of sensors.
%   Example:
...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    if flag ~= 0
        warning('Error in executing %s', 'pollyxt_tjk_display_monitor.py');
    end
    delete(tmpFile);
