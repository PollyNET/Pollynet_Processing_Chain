...
def pollyxt_tjk_display_WV(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_tjk_display_WV(tmpFile)
...
def main():
    pollyxt_tjk_display_WV('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_tjk_display_WV(sys.argv[1], sys.argv[2])