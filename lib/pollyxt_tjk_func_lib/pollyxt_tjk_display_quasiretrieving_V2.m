...
if strcmpi(processInfo.visualizationMode, 'matlab')
    ...
    file_quasi_bsc_355 = fullfile(processInfo.pic_folder, campaignInfo.name, datestr(data.mTime(1), 'yyyy'), datestr(data.mTime(1), 'mm'), datestr(data.mTime(1), 'dd'), sprintf('%s_Quasi_Bsc_355_V2.png', rmext(taskInfo.dataFilename)));
