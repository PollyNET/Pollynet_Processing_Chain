function [wvmr, rh, wvProfileInfo, WVMR, RH, IWV, quality_mask_WVMR, quality_mask_RH] = pollyxt_tjk_wv_retrieve(data, config, IWVIntRangeIndx)
%pollyxt_tjk_wv_retrieve retrieve the water vapor mixing ratio and relative humidity.
%   Example:
%       [wvmr, rh, wvProfileInfo, WVMR, RH] = pollyxt_tjk_wv_retrieve(data, config, IWVIntRangeIndx)
%   Inputs:
%		data: struct
