function [IWV, globalAttri] = pollyxt_tjk_read_IWV(data, config)
%pollyxt_tjk_read_IWV read integrated water vapor from external instruments, like Cimel sunphotometer and MWR.
%   Example:
%       [IWV, globalAttri] = pollyxt_tjk_read_IWV(data, config)
%   Inputs:
%       data.struct
