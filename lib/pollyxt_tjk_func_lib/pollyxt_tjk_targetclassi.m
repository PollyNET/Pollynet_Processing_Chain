function [tc_mask] = pollyxt_tjk_targetclassi(data, config)
%pollyxt_tjk_targetclassi Aerosol target classification based on algorithms presented in H.Baar et al, 2017, ATM.
%   Example:
