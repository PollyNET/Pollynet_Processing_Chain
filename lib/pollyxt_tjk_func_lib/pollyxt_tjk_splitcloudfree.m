function [cloudFreeSubContGroup] = pollyxt_tjk_splitcloudfree(data, config)
%pollyxt_tjk_splitcloudfree split the continous cloud free profiles into several small groups.
%   Example:
%       [cloudFreeSubContGroup] = pollyxt_tjk_splitcloudfree(data, config)
%   Inputs:
%       data.struct
