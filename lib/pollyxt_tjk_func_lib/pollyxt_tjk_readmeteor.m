function [temp, pres, relh, meteorAttri] = pollyxt_tjk_readmeteor(data, config)
%pollyxt_tjk_readmeteor Read meteorological data.
%   Example:
%       [temp, pres, relh, meteorAttri] = pollyxt_tjk_readmeteor(data, config)
%   Inputs:
%		data: struct
