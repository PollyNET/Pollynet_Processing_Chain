...
for iGroup = 1:size(data.cloudFreeGroups, 1)
    ...
    if any(flagChannel355)
        ...
        sig355 = NaN(size(data.signal, 2), 1);
    end
    ...
    if any(flagChannel532)
        ...
        sig532 = NaN(size(data.signal, 2), 1);
    end
    ...
    if any(flagChannel1064)
        ...
        sig1064 = NaN(size(data.signal, 2), 1);
    end
    ...
    if any(flagChannel355_NR)
        ...
        sig355_NR = NaN(size(data.signal, 2), 1);
    end
    ...
    if any(flagChannel532_NR)
        ...
        sig532_NR = NaN(size(data.signal, 2), 1);
    end
