function [] = pollyxt_tropos_display_retrieving(data, taskInfo, config)
%pollyxt_tropos_display_retrieving display aerosol optical products
%   Example:
...
if strcmpi(processInfo.visualizationMode, 'matlab')
    ...
    for iGroup = 1:size(data.cloudFreeGroups, 1)
        ...
        picFile = fullfile(processInfo.pic_folder, campaignInfo.name, datestr(data.mTime(1), 'yyyy'), datestr(data.mTime(1), 'mm'), datestr(data.mTime(1), 'dd'), sprintf('%s_%s_%s_WVMR.png', rmext(taskInfo.dataFilename), datestr(data.mTime(startIndx), 'HHMM'), datestr(data.mTime(endIndx), 'HHMM')));
    ...
    for iGroup = 1:size(data.cloudFreeGroups, 1)
        ...
        picFile = fullfile(processInfo.pic_folder, campaignInfo.name, datestr(data.mTime(1), 'yyyy'), datestr(data.mTime(1), 'mm'), datestr(data.mTime(1), 'dd'), sprintf('%s_%s_%s_RH.png', rmext(taskInfo.dataFilename), datestr(data.mTime(startIndx), 'HHMM'), datestr(data.mTime(endIndx), 'HHMM')));
