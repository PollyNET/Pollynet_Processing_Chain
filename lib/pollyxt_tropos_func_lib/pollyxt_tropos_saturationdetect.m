function [flag] = pollyxt_tropos_saturationdetect(data, config)
%pollyxt_tropos_saturationdetect detect the bins which is fully saturated by the clouds. The description about the detection algorithm can be found in doc/polly_defaults.md
%   Example:
%       [flag] = pollyxt_tropos_saturationdetect(data, height, config)
%   Inputs:
%       data: struct
