function [LCUsed355, LCUsedTag355, flagLCWarning355, LCUsed532, LCUsedTag532, flagLCWarning532, LCUsed1064, LCUsedTag1064, flagLCWarning1064] = pollyxt_tropos_save_LC(data, config, taskInfo, folder)
%pollyxt_tropos_save_LC calculate and save the lidar calibration constant based on the optional constants and defaults.
%   Example:
%       [LCUsed] = pollyxt_tropos_save_LC(data, config)
%   Inputs:
%		data: struct
