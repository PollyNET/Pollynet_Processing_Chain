function [wvconst, wvconstStd, globalAttri] = pollyxt_tropos_wv_calibration(data, config)
%pollyxt_tropos_wv_calibration water vapor calibration. The whole idea is based on the work of Guangyao. More detailed information can be found Guangyao et al, 2018, AMT.
%   Example:
%       [wvconst, wvconstStd, globalAttri] = pollyxt_tropos_wv_calibration(data, config)
%   Inputs:
%		data: struct
