function [] = pollyxt_tropos_save_tc_V2(data, taskInfo, config)
%pollyxt_tropos_save_tc_V2 Saving the target classification results to netcdf file. (Based on quasi retrieving results V2)
%   Example:
%       [] = pollyxt_tropos_save_tc_V2(data, config)
%   Inputs:
%       data.struct
