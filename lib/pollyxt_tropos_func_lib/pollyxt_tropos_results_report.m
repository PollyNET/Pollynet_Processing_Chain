...
% 1064 nm RCS FR
write_2_donelist(processInfo.doneListFile, 'a', taskInfo.pollyVersion, campaignInfo.location, datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'), datestr(taskInfo.startTime, 'yyyymmdd HH:MM:SS'), '1064', fullfile(datestr(data.mTime(1), 'yyyymmdd'), sprintf('%s_RCS_FR_1064.png', rmext(taskInfo.dataFilename))), '0', '1064 nm Far-Range', taskInfo.zipFile, num2str(taskInfo.dataSize), num2str(active), num2str(data.quasiAttri.flagGDAS1), datestr(data.quasiAttri.timestamp, 'yyyymmddHH'), '50', processInfo.programVersion, 'RCS_FR_1064', datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'));

% 355 nm RCS NR
write_2_donelist(processInfo.doneListFile, 'a', taskInfo.pollyVersion, campaignInfo.location, datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'), datestr(taskInfo.startTime, 'yyyymmdd HH:MM:SS'), '355', fullfile(datestr(data.mTime(1), 'yyyymmdd'), sprintf('%s_RCS_NR_355.png', rmext(taskInfo.dataFilename))), '0', '355 nm Near-Range', taskInfo.zipFile, num2str(taskInfo.dataSize), num2str(active), num2str(data.quasiAttri.flagGDAS1), datestr(data.quasiAttri.timestamp, 'yyyymmddHH'), '50', processInfo.programVersion, 'RCS_NR_355', datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'));
...
write_2_donelist(processInfo.doneListFile, 'a', taskInfo.pollyVersion, campaignInfo.location, datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'), datestr(taskInfo.startTime, 'yyyymmdd HH:MM:SS'), '355', fullfile(datestr(data.mTime(1), 'yyyymmdd'), sprintf('%s_SAT_NR_355.png', rmext(taskInfo.dataFilename))), '0', sprintf('signal status at 355 nm NR. SNR threshold is %d', config.mask_SNRmin(flag355NR)), taskInfo.zipFile, num2str(taskInfo.dataSize), num2str(active), num2str(data.quasiAttri.flagGDAS1), datestr(data.quasiAttri.timestamp, 'yyyymmddHH'), '50', processInfo.programVersion, 'SAT_NR_355', datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'));

% overlap results
write_2_donelist(processInfo.doneListFile, 'a', taskInfo.pollyVersion, campaignInfo.location, datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'), datestr(taskInfo.startTime, 'yyyymmdd HH:MM:SS'), '355', fullfile(datestr(data.mTime(1), 'yyyymmdd'), sprintf('%s_overlap.png', rmext(taskInfo.dataFilename))), '0', 'overlap function. Preliminary results only for Internal use. The overlap was calculated by comparing the signal between far-range and near-range channel cloud-free signal.', taskInfo.zipFile, num2str(taskInfo.dataSize), num2str(active), num2str(data.quasiAttri.flagGDAS1), datestr(data.quasiAttri.timestamp, 'yyyymmddHH'), '50', processInfo.programVersion, 'overlap', datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'));
...
% att-beta 1064
write_2_donelist(processInfo.doneListFile, 'a', taskInfo.pollyVersion, campaignInfo.location, datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'), datestr(taskInfo.startTime, 'yyyymmdd HH:MM:SS'), '1064', fullfile(datestr(data.mTime(1), 'yyyymmdd'), sprintf('%s_ATT_BETA_1064.png', rmext(taskInfo.dataFilename))), '0', sprintf('Lidar constant at 1064nm is %3.1e. Lidar constant calibration status: %s', data.LCUsed.LCUsed1064, config.LCCalibrationStatus{data.LCUsed.LCUsedTag1064 + 1}), taskInfo.zipFile, num2str(taskInfo.dataSize), num2str(active), num2str(data.quasiAttri.flagGDAS1), datestr(data.quasiAttri.timestamp, 'yyyymmddHH'), '50', processInfo.programVersion, 'ATT_BETA_1064', datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'));

% high temporal resolved WVMR
write_2_donelist(processInfo.doneListFile, 'a', taskInfo.pollyVersion, campaignInfo.location, datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'), datestr(taskInfo.startTime, 'yyyymmdd HH:MM:SS'), '407', fullfile(datestr(data.mTime(1), 'yyyymmdd'), sprintf('%s_WVMR.png', rmext(taskInfo.dataFilename))), '0', sprintf('Water vapor calibration constant is %5.1fg*kg^{-1}. Calibration status %s. %s.', data.wvconstUsed, flagWVCali{1}, meteorStr), taskInfo.zipFile, num2str(taskInfo.dataSize), num2str(active), num2str(data.quasiAttri.flagGDAS1), datestr(data.quasiAttri.timestamp, 'yyyymmddHH'), '50', processInfo.programVersion, 'WVMR', datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'));

% high temporal resolved RH
write_2_donelist(processInfo.doneListFile, 'a', taskInfo.pollyVersion, campaignInfo.location, datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'), datestr(taskInfo.startTime, 'yyyymmdd HH:MM:SS'), '407', fullfile(datestr(data.mTime(1), 'yyyymmdd'), sprintf('%s_RH.png', rmext(taskInfo.dataFilename))), '0', sprintf('Water vapor calibration constant is %5.1fg*kg^{-1}. Calibration status %s. %s.', data.wvconstUsed, flagWVCali{1}, meteorStr), taskInfo.zipFile, num2str(taskInfo.dataSize), num2str(active), num2str(data.quasiAttri.flagGDAS1), datestr(data.quasiAttri.timestamp, 'yyyymmddHH'), '50', processInfo.programVersion, 'RH', datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'));

% high temporal resolved VDR at 355 nm
write_2_donelist(processInfo.doneListFile, 'a', taskInfo.pollyVersion, campaignInfo.location, datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'), datestr(taskInfo.startTime, 'yyyymmdd HH:MM:SS'), '355', fullfile(datestr(data.mTime(1), 'yyyymmdd'), sprintf('%s_VDR_355.png', rmext(taskInfo.dataFilename))), '0', sprintf('Depolarization calibration factor is %f+-%f', data.depol_cal_fac_355, data.depol_cal_fac_std_355), taskInfo.zipFile, num2str(taskInfo.dataSize), num2str(active), num2str(data.quasiAttri.flagGDAS1), datestr(data.quasiAttri.timestamp, 'yyyymmddHH'), '50', processInfo.programVersion, 'VDR_355', datestr(data.mTime(1), 'yyyymmdd HH:MM:SS'), datestr(data.mTime(end), 'yyyymmdd HH:MM:SS'));
