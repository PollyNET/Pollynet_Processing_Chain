function [] = pollyxt_tropos_save_LC_txt(data, taskInfo, config)
%pollyxt_tropos_save_LC_txt  save the lidar constants
%   Example:
%       [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = pollyxt_tropos_save_LC_txt(data, taskInfo, config)
%   Inputs:
%       wvconst: array
