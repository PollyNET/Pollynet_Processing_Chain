...
def pollyxt_tropos_display_targetclassi(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_tropos_display_targetclassi(tmpFile)
    ...
    ax.set_title('Target classifications (V2) from {instrument} at {location}'.format(instrument=pollyVersion, location=location), fontweight='bold', fontsize=17)
...
def main():
    pollyxt_tropos_display_targetclassi('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_tropos_display_targetclassi(sys.argv[1], sys.argv[2])