...
def pollyxt_tropos_display_saturation(tmpFile, saveFolder):
    ...
    fig = plt.figure(figsize=[10, 5])
    ax = fig.add_axes([0.11, 0.15, 0.74, 0.75])
    pcmesh = ax.pcolormesh(Time, Height, SAT_NR_355,
                           vmin=-0.5, vmax=2.5, cmap=signal_status_colormap())
    ax.set_xlabel('UTC', fontsize=15)
    ax.set_ylabel('Height (m)', fontsize=15)
    ...
    fig = plt.figure(figsize=[10, 5])
    ax = fig.add_axes([0.11, 0.15, 0.74, 0.75])
    pcmesh = ax.pcolormesh(Time, Height, SAT_NR_532,
                           vmin=-0.5, vmax=2.5, cmap=signal_status_colormap())
    ax.set_xlabel('UTC', fontsize=15)
    ax.set_ylabel('Height (m)', fontsize=15)
    ...
    fig = plt.figure(figsize=[10, 5])
    ax = fig.add_axes([0.11, 0.15, 0.74, 0.75])
    pcmesh = ax.pcolormesh(Time, Height, SAT_FR_407,
                           vmin=-0.5, vmax=2.5, cmap=signal_status_colormap())
    ax.set_xlabel('UTC', fontsize=15)
    ax.set_ylabel('Height (m)', fontsize=15)
...
# display status of 387
    ...
    fig.savefig(
        os.path.join(
            saveFolder,
            '{dataFilename}_SAT_FR_387.png'.format(
                dataFilename=rmext(dataFilename)
                )
            ),
        dpi=figDPI
...
# display status of 607
    ...
    fig.savefig(
        os.path.join(
            saveFolder,
            '{dataFilename}_SAT_FR_607.png'.format(
                dataFilename=rmext(dataFilename)
                )
            ),
        dpi=figDPI
...
# display status of 387NR
    ...
    fig.savefig(
        os.path.join(
            saveFolder,
            '{dataFilename}_SAT_NR_387.png'.format(
                dataFilename=rmext(dataFilename)
                )
            ),
        dpi=figDPI
...
# display status of 607NR
    ...
    fig.savefig(
        os.path.join(
            saveFolder,
            '{dataFilename}_SAT_NR_607.png'.format(
                dataFilename=rmext(dataFilename)
                )
            ),
        dpi=figDPI
...
# display status of 355s FR
    ...
    fig.savefig(os.path.join(
        saveFolder, '{dataFilename}_SAT_FR_355s.png'.format(
            dataFilename=rmext(dataFilename)
        )), dpi=figDPI)
    plt.close()
    ...
    fig.savefig(
        os.path.join(
            saveFolder,
            '{dataFilename}_SAT_FR_532s.png'.format(
                dataFilename=rmext(dataFilename)
                )
            ),
        dpi=figDPI
...
def main():
    pollyxt_tropos_display_saturation(
