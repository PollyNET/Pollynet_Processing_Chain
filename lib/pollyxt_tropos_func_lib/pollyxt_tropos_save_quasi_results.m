function [] = pollyxt_tropos_save_quasi_results(data, taskInfo, config)
%pollyxt_tropos_save_quasi_results Saving the target classification results to netcdf file.
%   Example:
