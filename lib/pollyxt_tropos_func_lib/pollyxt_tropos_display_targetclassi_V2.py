...
def pollyxt_tropos_display_targetclassi_V2(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_tropos_display_targetclassi_V2(tmpFile)
    ...
    ax.set_title('Target classifications (V2) from {instrument} at {location}'.format(instrument=pollyVersion, location=location), fontweight='bold', fontsize=14)
...
def main():
    pollyxt_tropos_display_targetclassi_V2('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots\\POLLYXT_tropos\\20180517')

if __name__ == '__main__':
    # main()
    pollyxt_tropos_display_targetclassi_V2(sys.argv[1], sys.argv[2])