function [] = pollyxt_tropos_display_targetclassi(data, taskInfo, config)
%pollyxt_tropos_display_targetclassi display the target classification reuslts
%   Example:
...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    flag = system(sprintf('python %s %s %s', fullfile(pyFolder, 'pollyxt_tropos_display_targetclassi.py'), tmpFile, saveFolder));
    if flag ~= 0
