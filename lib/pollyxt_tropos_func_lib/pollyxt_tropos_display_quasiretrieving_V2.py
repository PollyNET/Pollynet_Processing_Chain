...
def pollyxt_tropos_display_quasiretrieving_V2(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_tropos_display_quasiretrieving_V2(tmpFile)
    ...
    ax.set_title('Quasi backscatter coefficient (V2) at {wave}nm from {instrument} at {location}'.format(wave=532, instrument=pollyVersion, location=location), fontweight='bold', fontsize=17)
    ...
    fig.text(0.05, 0.02, datenum_to_datetime(time[0]).strftime("%Y-%m-%d"), fontsize=17)
    fig.text(0.8, 0.02, 'Version: {version}'.format(version=version), fontsize=17)
    ...
    ax.set_title('Quasi backscatter coefficient (V2) at {wave}nm from {instrument} at {location}'.format(wave=1064, instrument=pollyVersion, location=location), fontweight='bold', fontsize=17)
    ...
    ax.set_title('Quasi particle depolarization ratio (V2) at {wave}nm from {instrument} at {location}'.format(wave=532, instrument=pollyVersion, location=location), fontweight='bold', fontsize=17)
    ...
    ax.set_title('Quasi BSC Angstoem Exponent 532-1064 (V2) from {instrument} at {location}'.format(instrument=pollyVersion, location=location), fontweight='bold', fontsize=17)
...
def main():
    pollyxt_tropos_display_quasiretrieving_V2('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_tropos_display_quasiretrieving_V2(sys.argv[1], sys.argv[2])