...
def pollyxt_tropos_display_quasiretrieving(tmpFile, saveFolder):
    ...
    plt.tight_layout()
    fig.savefigos.path.join(saveFolder, '{dataFilename}_Quasi_Bsc_532.png'.format(dataFilename=rmext(dataFilename))), dpi=figDPI)
    plt.close()
    ...
    plt.tight_layout()
    fig.savefigos.path.join(saveFolder, '{dataFilename}_Quasi_Bsc_1064.png'.format(dataFilename=rmext(dataFilename))), dpi=figDPI)
    plt.close()
    ...
    plt.tight_layout()
    fig.savefigos.path.join(saveFolder, '{dataFilename}_Quasi_PDR_532.png'.format(dataFilename=rmext(dataFilename))), dpi=figDPI)
    plt.close()
    ...
    plt.tight_layout()
    fig.savefigos.path.join(saveFolder, '{dataFilename}_Quasi_ANGEXP_532_1064.png'.format(dataFilename=rmext(dataFilename))), dpi=figDPI)
    plt.close()
