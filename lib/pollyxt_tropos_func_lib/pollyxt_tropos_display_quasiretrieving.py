...
def pollyxt_tropos_display_quasiretrieving(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_tropos_display_quasiretrieving(tmpFile)
    ...
    ax.set_title('Quasi backscatter coefficient at {wave}nm from {instrument} at {location}'.format(wave=532, instrument=pollyVersion, location=location), fontweight='bold', fontsize=17)
    ...
    ax.set_title('Quasi backscatter coefficient at {wave}nm from {instrument} at {location}'.format(wave=1064, instrument=pollyVersion, location=location), fontweight='bold', fontsize=17)
    ...
    ax.set_title('Quasi particle depolarization ratio at {wave}nm from {instrument} at {location}'.format(wave=532, instrument=pollyVersion, location=location), fontweight='bold', fontsize=17)
    ...
    ax.set_title('Quasi BSC Angstoem Exponent 532-1064 from {instrument} at {location}'.format(instrument=pollyVersion, location=location), fontweight='bold', fontsize=17)
...
def main():
    pollyxt_tropos_display_quasiretrieving('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_tropos_display_quasiretrieving(sys.argv[1], sys.argv[2])