function [] = pollyxt_tropos_save_NR_retrieving_results(data, taskInfo, config)
%pollyxt_tropos_save_NR_retrieving_results saving the retrieved results, including backscatter, extinction coefficients, lidar ratio, volume/particles depolarization ratio and so on.
%   Example:
