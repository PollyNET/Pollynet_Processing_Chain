function [] = pollyxt_tropos_save_tc(data, taskInfo, config)
%pollyxt_tropos_save_tc Saving the target classification results to netcdf file.
%   Example:
%       [] = pollyxt_tropos_save_tc(data, config)
%   Inputs:
%		data: struct
