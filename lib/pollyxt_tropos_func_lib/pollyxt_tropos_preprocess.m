function [ data ] = pollyxt_tropos_preprocess(data, config)
%pollyxt_tropos_preprocess deadtime correction, background correction, 
...
maskDepCalAng = {'none', 'none', 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'none', 'n', 'n', 'n', 'n', 'n', 'n', 'n', 'n'};   % the mask for postive and negative calibration angle. 'none' means invalid profiles with different depol_cal_angle
