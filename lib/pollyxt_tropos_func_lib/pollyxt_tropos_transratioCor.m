function [el355, bgEl355, el532, bgEl532] = pollyxt_tropos_transratioCor(data, config)
%pollyxt_tropos_transratioCor correct the effects of non-ideal transmission ratio in total channel to retrieve the real elastic signal.
%   Example:
%       [el355, bgEl355, el532, bgEl532] = pollyxt_tropos_transratioCor(data, config)
%   Inputs:
%		data: struct
