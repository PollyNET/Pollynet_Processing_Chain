...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    save(tmpFile, 'figDPI', 'time', 'height', 'xtick', 'xtickstr', 'SAT_FR_355', 'SAT_FR_532', 'SAT_FR_1064', 'SAT_NR_532', 'yLim_NR_RCS', 'yLim_FR_RCS', 'processInfo', 'campaignInfo', 'taskInfo', '-v6');
