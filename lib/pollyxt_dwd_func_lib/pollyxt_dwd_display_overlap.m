function [] = pollyxt_dwd_display_overlap(data, taskInfo, attri, config)
%pollyxt_dwd_display_overlap display the overlap function.
%   Example:
%       [] = pollyxt_dwd_display_overlap(height, overlap532, overlap355, overlap532Defaults, overlap355Defaults, file, config, campaignInfo)
%   Inputs:
%       height: array
...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    save(fullfile(tmpFolder, 'tmp.mat'), 'figDPI', 'overlap532', 'overlap532Defaults', 'sig532FR', 'sig532NR', 'sig532Gl', 'sigRatio532', 'normRange532', 'height', 'processInfo', 'campaignInfo', 'taskInfo');
