function [LCUsed355, LCUsedTag355, flagLCWarning355, LCUsed532, LCUsedTag532, flagLCWarning532, LCUsed1064, LCUsedTag1064, flagLCWarning1064] = pollyxt_dwd_mean_LC(data, config, taskInfo, folder)
%pollyxt_dwd_mean_LC calculate and save the lidar calibration constant based on the optional constants and defaults.
%   Example:
%       [LCUsed] = pollyxt_dwd_mean_LC(data, config)
%   Inputs:
%		data: struct
...
[LC355History, LC532History, LC1064History, LCStd355History, LCStd532History, LCStd1064History] = pollyxt_dwd_read_history_LC(taskInfo.dataTime, LCCaliFile, config);
