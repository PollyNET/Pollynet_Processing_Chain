...
quality_mask_355(nanrunmedian(squeeze(SNR(flagChannel355, :, :)), 2, 5) < config.mask_SNRmin(flagChannel355)) = 1;
quality_mask_532(nanrunmedian(squeeze(SNR(flagChannel532Tot, :, :)), 2, 5) < config.mask_SNRmin(flagChannel532Tot)) = 1;
quality_mask_1064(nanrunmedian(squeeze(SNR(flagChannel1064, :, :)), 2, 5) < config.mask_SNRmin(flagChannel1064)) = 1;
quality_mask_voldepol((nanrunmedian(squeeze(SNR(flagChannel532Cro, :, :)), 2, 5) < config.mask_SNRmin(flagChannel532Cro)) | (nanrunmedian(squeeze(SNR(flagChannel532Tot, :, :)), 2, 5) < config.mask_SNRmin(flagChannel532Tot))) = 1;
