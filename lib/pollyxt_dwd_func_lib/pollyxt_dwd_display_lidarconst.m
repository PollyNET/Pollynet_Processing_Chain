...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    %% display rcs 
    save(fullfile(tmpFolder, 'tmp.mat'), 'figDPI', 'time', 'thisTime', 'LC355_klett', 'LC355_raman', 'LC355_aeronet', 'LC532_klett', 'LC532_raman', 'LC532_aeronet', 'LC1064_klett', 'LC1064_raman', 'LC1064_aeronet', 'yLim355', 'yLim532', 'yLim1064', 'processInfo', 'campaignInfo', 'taskInfo', 'xtick', 'xtickstr');
