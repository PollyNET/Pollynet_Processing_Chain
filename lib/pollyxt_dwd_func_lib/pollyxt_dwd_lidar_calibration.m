...
for iGroup = 1:size(data.cloudFreeGroups, 1)
    ...
    hIndxBase = hIndxFullOverlap + ceil(config.smoothWin_klett_355/2);
    ...
    if ~ isnan(data.aerBsc355_klett(iGroup, 80))
        ...
        aerExt355_klett(1:hIndxBase) = aerExt355_klett(hIndxBase);
    ...
    if ~ isnan(data.aerBsc532_klett(iGroup, 80))
        ...
        aerExt532_klett(1:hIndxBase) = aerExt532_klett(hIndxBase);
    ...
    if ~ isnan(data.aerBsc1064_klett(iGroup, 80))
        ...
        aerExt1064_klett(1:hIndxBase) = aerExt1064_klett(hIndxBase);
...
for iGroup = 1:size(data.cloudFreeGroups, 1)
    ...
    hIndxBase = hIndxFullOverlap + ceil(config.smoothWin_raman_355/2);
    ...
    if ~ isnan(data.aerBsc355_raman(iGroup, 80))
        ...
        aerExt355_raman(1:hIndxBase) = aerExt355_raman(hIndxBase);
    ...
    if ~ isnan(data.aerBsc532_raman(iGroup, 80))
        ...
        aerExt532_raman(1:hIndxBase) = aerExt532_raman(hIndxBase);
    ...
    if ~ isnan(data.aerBsc1064_raman(iGroup, 80))
        ...
        aerExt1064_raman(1:hIndxBase) = aerExt1064_raman(hIndxBase);
...
for iGroup = 1:size(data.cloudFreeGroups, 1)
    ...
    hIndxBase = hIndxFullOverlap + ceil(config.smoothWin_aeronet_355/2);
    ...
    if ~ isnan(data.aerBsc355_aeronet(iGroup, 80))
        ...
        aerExt355_aeronet(1:hIndxBase) = aerExt355_aeronet(hIndxBase);
    ...
    if ~ isnan(data.aerBsc532_aeronet(iGroup, 80))
        ...
        aerExt532_aeronet(1:hIndxBase) = aerExt532_aeronet(hIndxBase);
    ...
    if ~ isnan(data.aerBsc1064_aeronet(iGroup, 80))
        ...
        aerExt1064_aeronet(1:hIndxBase) = aerExt1064_aeronet(hIndxBase);
