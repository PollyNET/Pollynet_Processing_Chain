...
%polly_molDepol etimate the molecular depolarization ratio according to the measurements at reference height.
%   Example:
...
%           default molecular depolarization ratio. Detailed information please go to doc/polly_defaults.md
%       defaultMolDepolStd: float
%           default std of molecular depolarization ratio. Detailed information please go to doc/polly_defaults.md
%   Outputs:
%       molDepol: float
...
%       flagDefault: logical
%           flag to show whether using the default values. If true, it means default molDepol and molDepolStd were used.
%   History:
...
[molDepol, molDepolStd] = polly_volDepol(sum(sigTot), sum(bgTot), sum(sigCro), sum(bgCro), Rt, RtStd, Rc, RcStd, depolConst, depolConstStd, 1);
flagDefault = false;
