function LCUsed = pollyxt_cge_select_liconst(data, config, dbFile)
%POLLYXT_CGE_SELECT_LICONST select the most suitable lidar calibration constants.
%Example:
%   LCUsed = pollyxt_cge_select_liconst(data, config, dbFile)
%Inputs:
%   data.struct
