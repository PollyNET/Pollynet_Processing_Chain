function [depolconst, depolconstStd, depolCaliTime] = pollyxt_dwd_search_history_depolconst(currentTime, file, deltaTime, defaults, wavelength)
%pollyxt_dwd_search_history_depolconst Search the previous calibration constants with a time lag less than deltaTime.
%   Example:
%       [depolconst, depolconstStd, depolCaliTime] = pollyxt_dwd_search_history_depolconst(file, deltaTime, defaults)
%   Inputs:
%       file: char
...
[preDepolCaliTime, preDepolconst, preDepolconstStd] = pollyxt_dwd_read_depolconst(file);
