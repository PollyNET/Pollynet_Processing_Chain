...
def pollyxt_cge_display_overlap(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_cge_display_overlap(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyxt_cge_display_overlap(sys.argv[1], sys.argv[2])
