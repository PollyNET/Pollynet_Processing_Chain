function [el532, bgEl532] = pollyxt_cge_transratioCor(data, config)
%pollyxt_cge_transratioCor correct the effects of non-ideal transmission ratio in total channel to retrieve the real elastic signal.
%   Example:
%       [el532, bgEl532] = pollyxt_cge_transratioCor(data, config)
%   Inputs:
%       data.struct
