function [] = pollyxt_cge_display_rcs(data, taskInfo, config)
%pollyxt_cge_display_rcs display the range corrected signal, vol-depol at 355 and 532 nm
%   Example:
%       [] = pollyxt_cge_display_rcs(data, config)
%   Inputs:
%		data: struct
