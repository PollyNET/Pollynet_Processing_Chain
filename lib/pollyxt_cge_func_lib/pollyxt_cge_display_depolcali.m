function [] = pollyxt_cge_display_depolcali(data, taskInfo, attri)
%pollyxt_cge_display_depolcali display the depolarization calibration results
%   Example:
%       [] = pollyxt_cge_display_depolcali(attri)
%   Inputs:
%       attri
%   Outputs:
%       
