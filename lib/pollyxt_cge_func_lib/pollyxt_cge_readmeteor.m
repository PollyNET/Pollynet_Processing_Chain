function [temp, pres, relh, meteorAttri] = pollyxt_cge_readmeteor(data, config)
%pollyxt_cge_readmeteor Read meteorological data.
%   Example:
%       [temp, pres, relh, meteorAttri] = pollyxt_cge_readmeteor(data, config)
%   Inputs:
%		data: struct
