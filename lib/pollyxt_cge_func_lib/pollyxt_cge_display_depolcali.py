...
def pollyxt_cge_display_depolcali(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_cge_display_depolcali(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyxt_cge_display_depolcali(sys.argv[1], sys.argv[2])
