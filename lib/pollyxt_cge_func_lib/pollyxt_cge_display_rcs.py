...
def pollyxt_cge_display_rcs(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_cge_display_rcs(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyxt_cge_display_rcs(sys.argv[1], sys.argv[2])
