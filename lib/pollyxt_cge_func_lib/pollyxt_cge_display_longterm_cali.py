...
def pollyxt_dwd_display_longterm_cali(tmpFile, saveFolder):
    ...
    fig, (ax1, ax2, ax3, ax4, ax5) = plt.subplots(5, figsize=(10,10), sharex=True, gridspec_kw={'height_ratios': [1, 1, 1, 1, 1], 'hspace': 0.1})
...
def main():
    pollyxt_dwd_display_longterm_cali('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')
