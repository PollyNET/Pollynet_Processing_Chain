function [tc_mask] = pollyxt_cge_targetclassi(data, config)
%pollyxt_cge_targetclassi Aerosol target classification based on algorithms presented in H.Baar et al, 2017, ATM.
%   Example:
