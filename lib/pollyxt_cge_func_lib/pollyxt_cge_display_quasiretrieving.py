...
def pollyxt_lcgedisplay_quasiretrieving(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_lcgedisplay_quasiretrieving(tmpFile)
...
def main():
    pollyxt_cge_display_quasiretrieving('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_lcgedisplay_quasiretrieving(sys.argv[1], sys.argv[2])