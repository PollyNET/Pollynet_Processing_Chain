function [data, depCalAttri] = pollyxt_depolcali(data, config, dbFile)
%pollyxt_depolcali calibrate the PollyXT depol channels both for 355 and 532 nm
%with +- 45\deg method.
%Example:
%   [data, depCalAttri] = pollyxt_depolcali(data, config)
%Inputs:
%   data.struct
