...
for iCh = 1:nChs
    ...
    elseif isempty(chTagsI) && (any(p.Results.flagFarRangeChannel | ...
        ...
        chTagsO(iCh) = sum(2.^(0:(13 - 1)) .* [p.Results.flagFarRangeChannel(iCh), ...
        ...
        p.Results.flag532nmChannel(iCh), p.Results.flag607nmChannel(iCh), p.Results.flag1064nmChannel(iCh), p.Results.flag1058nmChannel(iCh)]);
    else
