...
def pollyDisplayAttnBsc532NR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayAttnBsc532NR(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayAttnBsc532NR(sys.argv[1], sys.argv[2])
