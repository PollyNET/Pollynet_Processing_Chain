...
def pollyDisplayAttnBsc1064FR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayAttnBsc1064FR(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayAttnBsc1064FR(sys.argv[1], sys.argv[2])
