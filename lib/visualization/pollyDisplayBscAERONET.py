...
def pollyDisplayBscAERONET(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayBscAERONET(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayBscAERONET(sys.argv[1], sys.argv[2])
