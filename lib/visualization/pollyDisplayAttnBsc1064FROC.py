...
def pollyDisplayAttnBsc1064FROC(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayAttnBsc1064FROC(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayAttnBsc1064FROC(sys.argv[1], sys.argv[2])
