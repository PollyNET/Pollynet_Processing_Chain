...
def pollyDisplayAttnBsc532FR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayAttnBsc532FR(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayAttnBsc532FR(sys.argv[1], sys.argv[2])
