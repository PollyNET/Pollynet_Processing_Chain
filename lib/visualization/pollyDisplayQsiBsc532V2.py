...
def pollyDisplayQsiBsc532V2(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayQsiBsc532V2(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayQsiBsc532V2(sys.argv[1], sys.argv[2])
