...
def pollyDisplayExtAERONET(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayExtAERONET(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayExtAERONET(sys.argv[1], sys.argv[2])
