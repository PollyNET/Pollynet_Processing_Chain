...
def pollyDisplayOCExtRaman(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayOCExtRaman(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayOCExtRaman(sys.argv[1], sys.argv[2])
