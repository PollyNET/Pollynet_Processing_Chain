...
def pollyDisplayOCBscRaman(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayOCBscRaman(tmpFile, saveFolder)
    ...
    fig.text(
        0.02, 0.01, 'Version: {0}\n'.format(version) +
        'Method: {0}'.format('Raman'), fontsize=12)
...
if __name__ == '__main__':
    # main()
    pollyDisplayOCBscRaman(sys.argv[1], sys.argv[2])
