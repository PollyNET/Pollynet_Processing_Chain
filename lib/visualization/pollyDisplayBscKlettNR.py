...
def pollyDisplayBscKlettNR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayBscKlettNR(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayBscKlettNR(sys.argv[1], sys.argv[2])
