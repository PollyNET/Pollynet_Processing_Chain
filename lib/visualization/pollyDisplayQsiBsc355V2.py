...
def pollyDisplayQsiBsc355V2(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayQsiBsc355V2(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayQsiBsc355V2(sys.argv[1], sys.argv[2])
