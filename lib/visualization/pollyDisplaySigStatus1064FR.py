...
def pollyDisplaySigStatus1064FR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplaySigStatus1064FR(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyDisplaySigStatus1064FR(sys.argv[1], sys.argv[2])
