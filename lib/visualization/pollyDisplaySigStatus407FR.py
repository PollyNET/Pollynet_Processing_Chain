...
def pollyDisplaySigStatus407FR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplaySigStatus407FR(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyDisplaySigStatus407FR(sys.argv[1], sys.argv[2])
