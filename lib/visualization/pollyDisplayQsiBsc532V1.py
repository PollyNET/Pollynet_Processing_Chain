...
def pollyDisplayQsiBsc532V1(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayQsiBsc532V1(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayQsiBsc532V1(sys.argv[1], sys.argv[2])
