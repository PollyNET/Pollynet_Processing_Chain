...
def pollyDisplayAERamanNR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayAERamanNR(tmpFile, saveFolder)
    ...
    try:
        ...
        height = mat['height'][:][0]
        time = mat['time'][:][0]
        AE_Ext_355_532_NR_raman = mat['AE_Ext_355_532_NR_raman'][:][0]
        AE_Bsc_355_532_NR_raman = mat['AE_Bsc_355_532_NR_raman'][:][0]
    ...
    p1, = ax.plot(AE_Bsc_355_532_NR_raman, height, color='#ff8000',
                  linestyle='-', label='BSC 355-532 (NR)', zorder=2)
    p3, = ax.plot(AE_Ext_355_532_NR_raman, height, color='#000000',
                  linestyle='-', label='EXT 355-532 (NR)', zorder=2)

    ax.set_xlabel('Angstroem Exponent', fontsize=15)
    ax.set_ylabel('Height (m)', fontsize=15)
    ax.legend(handles=[p1, p3], loc='upper right', fontsize=15)
...
if __name__ == '__main__':
    # main()
    pollyDisplayAERamanNR(sys.argv[1], sys.argv[2])
