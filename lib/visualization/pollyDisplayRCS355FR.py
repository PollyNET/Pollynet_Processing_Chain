...
def pollyDisplayRCS355FR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayRCS355FR(tmpFile, saveFolder)
    ...
    depCalMask = np.tile(depCalMask, (RCS_FR_355.shape[0], 1))
    fogMask = np.tile(fogMask, (RCS_FR_355.shape[0], 1))
...
if __name__ == '__main__':
    # main()
    pollyDisplayRCS355FR(sys.argv[1], sys.argv[2])
