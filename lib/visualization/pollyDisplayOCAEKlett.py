...
def pollyDisplayOCAEKlett(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayOCAEKlett(tmpFile, saveFolder)
    ...
    try:
        ...
        height = mat['height'][:][0]
        time = mat['time'][:][0]
        AE_Bsc_355_532_klett = mat['AE_Bsc_355_532_klett'][:][0]
        AE_Bsc_532_1064_klett = mat['AE_Bsc_532_1064_klett'][:][0]
    ...
    p1, = ax.plot(AE_Bsc_355_532_klett, height, color='#ff8000',
                  linestyle='-', label='BSC 355-532', zorder=2)
    p2, = ax.plot(AE_Bsc_532_1064_klett, height, color='#ff00ff',
...
if __name__ == '__main__':
    # main()
    pollyDisplayOCAEKlett(sys.argv[1], sys.argv[2])
