...
def pollyDisplayOCAERaman(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayOCAERaman(tmpFile, saveFolder)
    ...
    try:
        ...
        height = mat['height'][:][0]
        time = mat['time'][:][0]
        AE_Bsc_355_532_raman = mat['AE_Bsc_355_532_raman'][:][0]
        AE_Bsc_532_1064_raman = mat['AE_Bsc_532_1064_raman'][:][0]
        AE_Ext_355_532_raman = mat['AE_Ext_355_532_raman'][:][0]
    ...
    p1, = ax.plot(AE_Bsc_355_532_raman, height, color='#ff8000',
                  linestyle='-', label='BSC 355-532', zorder=2)
    p2, = ax.plot(AE_Bsc_532_1064_raman, height, color='#ff00ff',
                  linestyle='-', label='BSC 532-1064', zorder=2)
    p3, = ax.plot(AE_Ext_355_532_raman, height, color='#000000',
...
if __name__ == '__main__':
    # main()
    pollyDisplayOCAERaman(sys.argv[1], sys.argv[2])
