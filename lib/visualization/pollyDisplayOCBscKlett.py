...
def pollyDisplayOCBscKlett(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayOCBscKlett(tmpFile, saveFolder)
    ...
    fig.text(
        0.02, 0.01, 'Version: {0}\n'.format(version) +
        'Method: {0}'.format('Klett'), fontsize=12)
...
if __name__ == '__main__':
    # main()
    pollyDisplayOCBscKlett(sys.argv[1], sys.argv[2])
