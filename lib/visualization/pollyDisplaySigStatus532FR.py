...
def pollyDisplaySigStatus532FR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplaySigStatus532FR(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyDisplaySigStatus532FR(sys.argv[1], sys.argv[2])
