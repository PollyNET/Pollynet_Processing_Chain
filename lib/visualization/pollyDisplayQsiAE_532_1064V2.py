...
def pollyDisplayQsiAE_532_1064V2(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayQsiAE_532_1064V2(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayQsiAE_532_1064V2(sys.argv[1], sys.argv[2])
