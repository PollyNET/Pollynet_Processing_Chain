...
def polly_1st_displayHousekeeping(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    polly_1st_displayHousekeeping(tmpFile)
...
def main():
    polly_1st_displayHousekeeping(
        'C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat',
        'C:\\Users\\zhenping\\Desktop\\Picasso\\' +
        'recent_plots\\pollyxt_first\\20180517')


if __name__ == '__main__':
    # main()
    polly_1st_displayHousekeeping(sys.argv[1], sys.argv[2])
