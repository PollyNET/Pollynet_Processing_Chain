...
def pollyDisplayExtKlettNR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayExtKlettNR(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayExtKlettNR(sys.argv[1], sys.argv[2])
