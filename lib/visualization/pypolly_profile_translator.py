...
def OC_profile_translator_function():
    ...
    profilename_ls = ['Bsc_Klett_OC','Bsc_Raman_OC','Ext_Raman_OC','LR_Raman_OC']
...
#    profile_translator['DepRatio_Klett_OC']['var_name_ls'] = ['volDepol_klett_355','volDepol_klett_532','volDepol_klett_1064',\
#                                                              'parDepol_klett_355','parDepol_klett_532','parDepol_klett_1064']                        
#    profile_translator['DepRatio_Klett_OC']['var_err_name_ls'] = ['']
#    profile_translator['DepRatio_Klett_OC']['var_color_ls'] = ['blue','green','red','blue','green','red']
...
#    profile_translator['DepRatio_Raman_OC']['var_name_ls'] = ['volDepol_raman_355','volDepol_raman_532','volDepol_raman_1064',\
#                                                              'parDepol_raman_355','parDepol_raman_532','parDepol_raman_1064']
#    profile_translator['DepRatio_Raman_OC']['var_err_name_ls'] = ['']
#    profile_translator['DepRatio_Raman_OC']['var_color_ls'] = ['blue','green','red','blue','green','red']
