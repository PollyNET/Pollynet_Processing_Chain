...
def pollyDisplayAttnBsc532FROC(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayAttnBsc532FROC(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayAttnBsc532FROC(sys.argv[1], sys.argv[2])
