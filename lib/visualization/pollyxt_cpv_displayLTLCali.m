function pollyxt_cpv_displayLTLCali(data, dbFile)
...
% 1064 nm
[depolCaliConst1064, ~, caliStartTime1064, caliStopTime1064] = ...
    loadDepolConst(PollyDataInfo.dataTime, dbFile, CampaignConfig.name, '1064', 'flagBeforeQuery', true);
if ~ isempty(caliStartTime1064)
    depolCaliTime1064 = mean([caliStartTime1064; caliStopTime1064], 1);
else
    depolCaliTime1064 = [];
end
...
depolConstLim1064 = PollyConfig.yLim_depolConst_1064;
