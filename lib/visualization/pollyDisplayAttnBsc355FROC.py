...
def pollyDisplayAttnBsc355FROC(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayAttnBsc355FROC(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayAttnBsc355FROC(sys.argv[1], sys.argv[2])
