...
def pollyDisplaySigStatus355NR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplaySigStatus355NR(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyDisplaySigStatus355NR(sys.argv[1], sys.argv[2])
