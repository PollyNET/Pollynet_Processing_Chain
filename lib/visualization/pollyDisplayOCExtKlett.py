...
def pollyDisplayOCExtKlett(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayOCExtKlett(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayOCExtKlett(sys.argv[1], sys.argv[2])
