...
def pollyDisplayRCS355NR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayRCS355NR(tmpFile, saveFolder)
    ...
    depCalMask = np.tile(depCalMask, (RCS_NR_355.shape[0], 1))
    fogMask = np.tile(fogMask, (RCS_NR_355.shape[0], 1))
...
if __name__ == '__main__':
    # main()
    pollyDisplayRCS355NR(sys.argv[1], sys.argv[2])
