...
def pollyxt_cge_displayLTLCali(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_cge_displayLTLCali(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyxt_cge_displayLTLCali(sys.argv[1], sys.argv[2])
