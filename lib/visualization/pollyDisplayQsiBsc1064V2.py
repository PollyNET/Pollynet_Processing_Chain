...
def pollyDisplayQsiBsc1064V2(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplayQsiBsc1064V2(tmpFile, saveFolder)
...
if __name__ == '__main__':
    # main()
    pollyDisplayQsiBsc1064V2(sys.argv[1], sys.argv[2])
