...
def pollyxt_ift_displayHousekeeping(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_ift_displayHousekeeping(tmpFile)
...
def main():
    pollyxt_ift_displayHousekeeping(
...
if __name__ == '__main__':
    # main()
    pollyxt_ift_displayHousekeeping(sys.argv[1], sys.argv[2])
