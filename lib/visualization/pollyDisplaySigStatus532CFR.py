...
def pollyDisplaySigStatus532CFR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplaySigStatus532CFR(tmpFile)
    ...
    fig.savefig(os.path.join(
        saveFolder, '{dataFilename}_SAT_FR_532s.{imgFmt}'.format(
...
if __name__ == '__main__':
    # main()
    pollyDisplaySigStatus532CFR(sys.argv[1], sys.argv[2])
