...
def pollyDisplaySigStatus355FR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplaySigStatus355FR(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyDisplaySigStatus355FR(sys.argv[1], sys.argv[2])
