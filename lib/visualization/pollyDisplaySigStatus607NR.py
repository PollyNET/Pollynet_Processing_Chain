...
def pollyDisplaySigStatus607NR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplaySigStatus607NR(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyDisplaySigStatus607NR(sys.argv[1], sys.argv[2])
