...
def pollyxt_dwd_displayHousekeeping(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_dwd_displayHousekeeping(tmpFile)
...
def main():
    pollyxt_dwd_displayHousekeeping(
...
if __name__ == '__main__':
    # main()
    pollyxt_dwd_displayHousekeeping(sys.argv[1], sys.argv[2])
