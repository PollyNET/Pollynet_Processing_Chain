function pollyxt_dwd_displayLTLCali(data, dbFile)
% POLLYXT_DWD_DISPLAYLTLCALI display long-term lidar calibration results.
% USAGE:
%    pollyxt_dwd_displayLTLCali(data)
% INPUTS:
%    data: struct
%    dbFile: char
% EXAMPLE:
