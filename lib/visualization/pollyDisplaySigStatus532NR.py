...
def pollyDisplaySigStatus532NR(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyDisplaySigStatus532NR(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyDisplaySigStatus532NR(sys.argv[1], sys.argv[2])
