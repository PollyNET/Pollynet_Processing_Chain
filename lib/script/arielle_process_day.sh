...
write_daily_to_filelist('$POLLY_TYPE', '$POLLY_FOLDER', fullfile(POLLYNET_PROCESSING_DIR,  'config', '$POLLYNET_CONFIG_FILE'), $1, $2, $3, 'w');
...
POLLY_TYPE="arielle"
POLLYNET_CONFIG_FILE="pollynet_processsing_chain_config.json"
year="2000"
month="01"
day="01"
