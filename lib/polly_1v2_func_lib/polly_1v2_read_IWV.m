function [IWV, globalAttri] = polly_1v2_read_IWV(data, config)
%polly_1v2_read_IWV read integrated water vapor from external instruments, like Cimel sunphotometer and MWR.
%   Example:
%       [IWV, globalAttri] = polly_1v2_read_IWV(data, config)
%   Inputs:
%       data.struct
