...
def polly_1v2_display_saturation(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    polly_1v2_display_saturation(tmpFile)
...
def main():
    polly_1v2_display_saturation('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    polly_1v2_display_saturation(sys.argv[1], sys.argv[2])