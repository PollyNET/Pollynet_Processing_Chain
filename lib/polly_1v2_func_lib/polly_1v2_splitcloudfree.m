function [cloudFreeSubContGroup] = polly_1v2_splitcloudfree(data, config)
%polly_1v2_splitcloudfree split the continous cloud free profiles into several small groups.
%   Example:
