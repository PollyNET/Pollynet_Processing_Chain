...
def polly_1v2_display_quasiretrieving(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    polly_1v2_display_quasiretrieving(tmpFile)
...
def main():
    polly_1v2_display_quasiretrieving('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    polly_1v2_display_quasiretrieving(sys.argv[1], sys.argv[2])