function [] = polly_1v2_display_targetclassi(data, taskInfo, config)
%polly_1v2_display_targetclassi display the target classification reuslts
%   Example:
%       [] = polly_1v2_display_targetclassi(data, taskInfo, config)
%   Inputs:
