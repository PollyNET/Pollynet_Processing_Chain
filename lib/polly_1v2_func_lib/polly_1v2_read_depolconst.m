function [datetime, depolconst, depolconstStd] = polly_1v2_read_depolconst(depolconstFile)
%polly_1v2_read_depolconst read the depolarization calibration results from the file.
%   Example:
%       [datetime, depolconst, depolconstStd] = polly_1v2_read_depolconst(depolconstFile)
%   Inputs:
%       depolconstFile: char
