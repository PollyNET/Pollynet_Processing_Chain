function [tc_mask] = polly_1v2_targetclassi(data, config)
%polly_1v2_targetclassi Aerosol target classification based on algorithms presented in H.Baar et al, 2017, ATM.
%   Example:
%       [tc_mask] = polly_1v2_targetclassi(data, config)
%   Inputs:
%		data: struct
