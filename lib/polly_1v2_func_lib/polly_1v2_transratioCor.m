function [el532, bgEl532] = polly_1v2_transratioCor(data, config)
%polly_1v2_transratioCor correct the effects of non-ideal transmission ratio in total channel to retrieve the real elastic signal.
%   Example:
%       [el532, bgEl532] = polly_1v2_transratioCor(data, config)
%   Inputs:
%       data.struct
