function [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = pollyxt_1v2_select_wvconst(wvconst, wvconstStd, IWVAttri, currentTime, file, flagUsePreviousWVConst)
%pollyxt_1v2_select_wvconst  select the most appropriate water vapor 
%calibration constant to calculate the WVMR and RH.
%   Example:
%       [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = 
%           pollyxt_1v2_select_wvconst(wvconst, wvconstStd, WVCaliInfo, 
...
if isempty(wvconst)
    [wvconstUsed, wvconstUsedStd] = pollyxt_1v2_search_wvconst(currentTime, ...
