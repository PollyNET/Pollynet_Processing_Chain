...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    %% display rcs 
    save(fullfile(tmpFolder, 'tmp.mat'), 'figDPI', 'LCTime', 'LC532Status', 'LC532History', 'LCStd532History', 'logbookTime', 'flagOverlap', 'flagWindowwipe', 'flagFlashlamps', 'flagPulsepower', 'flagRestart', 'flag_CH_NDChange', 'flagCH532FR', 'flagCH532FR_X', 'else_time', 'else_label', 'yLim532', 'processInfo', 'campaignInfo', 'taskInfo');
