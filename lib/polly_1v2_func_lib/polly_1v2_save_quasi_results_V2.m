function [] = polly_1v2_save_quasi_results_V2(data, taskInfo, config)
%polly_1v2_save_quasi_results_V2 Saving the target classification results to netcdf file.
%   Example:
%       [] = polly_1v2_save_quasi_results_V2(data, config)
%   Inputs:
%       data.struct
