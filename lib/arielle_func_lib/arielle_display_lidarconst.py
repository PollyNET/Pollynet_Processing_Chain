...
def arielle_display_lidarconst(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    arielle_display_lidarconst(tmpFile)
...
def main():
    arielle_display_lidarconst('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    arielle_display_lidarconst(sys.argv[1], sys.argv[2])