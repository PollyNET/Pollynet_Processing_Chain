function [el355, bgEl355, el532, bgEl532] = arielle_transratioCor(data, config)
%arielle_transratioCor correct the effects of non-ideal transmission ratio in total channel to retrieve the real elastic signal.
%   Example:
