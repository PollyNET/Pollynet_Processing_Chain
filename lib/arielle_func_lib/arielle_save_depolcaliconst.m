function arielle_save_depolcaliconst(depolConst, depolConstStd, ...
            depolCaliTime, dataFilename, depol_cal_fac, depol_cal_fac_std, file)
%ARIELLE_SAVE_DEPOLCALICONST save the depolarization calibration results.
%Example:
%   arielle_save_depolcaliconst(depolConst, depolConstStd, depolCaliTime,
...
%Note: 
%   The depolarization calibration results will be saved to "file". If there is
%   no depolarization calibration results, defaults results will be used as
%   replacement.
%History:
%   2018-12-19. First Edition by Zhenping
%   2019-02-26. Replace the defaults calibration constant with applied depol
%               calibration factor. The latter takes into account of previous
%               calibration results.
%Contact:
%   zhenping@tropos.de
