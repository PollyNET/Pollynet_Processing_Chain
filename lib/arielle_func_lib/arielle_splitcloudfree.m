function [cloudFreeSubContGroup] = arielle_splitcloudfree(data, config)
%arielle_splitcloudfree split the continous cloud free profiles into several small groups.
%   Example:
%       [cloudFreeSubContGroup] = arielle_splitcloudfree(data, config)
%   Inputs:
%		data: struct
