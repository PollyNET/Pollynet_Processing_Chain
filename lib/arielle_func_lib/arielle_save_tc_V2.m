function [] = arielle_save_tc_V2(data, taskInfo, config)
%arielle_save_tc_V2 Saving the target classification results to netcdf file. (Based on quasi retrieving results V2)
%   Example:
%       [] = arielle_save_tc_V2(data, config)
%   Inputs:
%		data: struct
