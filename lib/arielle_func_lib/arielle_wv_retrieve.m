function [wvmr, rh, wvProfileInfo, WVMR, RH, IWV, quality_mask_WVMR, quality_mask_RH] = arielle_wv_retrieve(data, config, IWVIntRangeIndx)
%arielle_wv_retrieve retrieve the water vapor mixing ratio and relative humidity.
%   Example:
%       [wvmr, rh, wvProfileInfo, WVMR, RH] = arielle_wv_retrieve(data, config, IWVIntRangeIndx)
%   Inputs:
%		data: struct
