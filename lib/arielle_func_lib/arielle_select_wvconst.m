function [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = arielle_select_wvconst(wvconst, wvconstStd, IWVAttri, currentTime, file, flagUsePreviousWVConst)
%arielle_select_wvconst  select the most appropriate water vapor 
%calibration constant to calculate the WVMR and RH.
%   Example:
%       [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = 
%           arielle_select_wvconst(wvconst, wvconstStd, WVCaliInfo, 
