function [datetime, wvCaliFlag, wvconst, wvconstStd] = arielle_read_wvconst(wvconstFile)
%arielle_read_wvconst read the depolarization calibration results from the file.
%   Example:
%       [datetime, wvconst, wvconstStd] = arielle_read_wvconst(wvconstFile)
%   Inputs:
%       wvconstFile: char
