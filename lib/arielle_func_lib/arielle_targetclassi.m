function [tc_mask] = arielle_targetclassi(data, config)
%arielle_targetclassi Aerosol target classification based on algorithms presented in H.Baar et al, 2017, ATM.
%   Example:
