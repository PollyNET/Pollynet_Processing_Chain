function [datetime, depolconst, depolconstStd] = arielle_read_depolconst(depolconstFile)
%arielle_read_depolconst read the depolarization calibration results from the file.
%   Example:
%       [datetime, depolconst, depolconstStd] = arielle_read_depolconst(depolconstFile)
%   Inputs:
%       depolconstFile: char
