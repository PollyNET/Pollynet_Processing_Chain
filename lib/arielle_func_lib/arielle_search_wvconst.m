function [wvconst, wvconstStd] = arielle_search_wvconst(currentTime, file, deltaTime, defaults)
%arielle_search_wvconst Search the previous calibration constants with a time lag less than deltaTime.
%   Example:
%       [wvconst, wvconstStd] = arielle_search_wvconst(currentTime, file, deltaTime, defaults)
%   Inputs:
%       currentTime: datenum
...
[preWVlCaliTime, preWVconst, preWVconstStd] = arielle_read_wvconst(file);
