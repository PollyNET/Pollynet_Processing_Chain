function [] = arielle_save_quasi_results(data, taskInfo, config)
%arielle_save_quasi_results Saving the target classification results to netcdf file.
%   Example:
%       [] = arielle_save_quasi_results(data, config)
%   Inputs:
%		data: struct
