function [depolconst, depolconstStd, depolCaliTime] = arielle_search_history_depolconst(currentTime, file, deltaTime, defaults, wavelength)
%arielle_search_history_depolconst Search the previous calibration constants with a time lag less than deltaTime.
%   Example:
%       [depolconst, depolconstStd, depolCaliTime] = arielle_search_history_depolconst(file, deltaTime, defaults)
%   Inputs:
%       file: char
...
[preDepolCaliTime, preDepolconst, preDepolconstStd] = arielle_read_depolconst(file);
