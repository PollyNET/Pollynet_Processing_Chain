function [] = arielle_display_rcs(data, taskInfo, config)
%arielle_display_rcs display the range corrected signal, vol-depol at 355 and 532 nm
%   Example:
%       [] = arielle_display_rcs(data, config)
%   Inputs:
%		data: struct
...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    if flag ~= 0
        warning('Error in executing %s', 'arielle_display_rcs.py');
    end
