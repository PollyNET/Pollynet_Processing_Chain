...
def pollyxt_first_display_monitor(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_first_display_monitor(tmpFile)
...
if __name__ == '__main__':
    # main()
    pollyxt_first_display_monitor(sys.argv[1], sys.argv[2])
