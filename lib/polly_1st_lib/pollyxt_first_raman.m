function [aerBsc532_raman, aerExt532_raman,LR532_raman] = pollyxt_first_raman(data, config)
%polly_first_raman Retrieve aerosol optical properties with raman method
%   Example:
%       [aerBsc532_raman,  aerExt532_raman,  LR532_raman] = polly_1v2_raman(data, config)
%   Inputs:
%       data.struct
