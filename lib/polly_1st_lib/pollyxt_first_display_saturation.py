...
def pollyxt_first_display_saturation(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_first_display_saturation(tmpFile)
...
def main():
    pollyxt_first_display_saturation(
...
if __name__ == '__main__':
    # main()
    pollyxt_first_display_saturation(sys.argv[1], sys.argv[2])
