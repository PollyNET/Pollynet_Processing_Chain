function [aerBsc532_klett, aerExt532_klett] = pollyxt_first_klett(data, config)
%pollyxt_first_klett Retrieve aerosol optical properties with klett method
%   Example:
%       [aerBsc532_klett, aerExt532_klett] = pollyxt_first_klett(data, config)
%   Inputs:
%       data.struct
