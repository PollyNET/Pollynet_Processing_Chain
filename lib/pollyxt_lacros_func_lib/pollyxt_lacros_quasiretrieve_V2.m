function [quasi_par_bsc_355_V2, quasi_par_bsc_532_V2, quasi_par_bsc_1064_V2, quasi_par_depol_532_V2, volDepol_355, volDepol_532, quasi_ang_532_1064_V2, quality_mask_355_V2, quality_mask_532_V2, quality_mask_1064_V2, quality_mask_volDepol_355_V2, quality_mask_volDepol_532_V2, quasiAttri_V2] = pollyxt_lacros_quasiretrieve_V2(data, config)
%pollyxt_lacros_quasiretrieve_V2 Retrieving the intensive aerosol optical properties with Quasi-retrieving method. Detailed information can be found in doc/pollynet_processing_program.md
%   Example:
%       [quasi_par_bsc_355_V2, quasi_par_bsc_532_V2, quasi_par_bsc_1064_V2, quasi_par_depol_532_V2, volDepol_355, volDepol_532, quasi_ang_532_1064, quality_mask_355_V2, quality_mask_532_V2, quality_mask_1064_V2, quality_mask_volDepol_355_V2, quality_mask_volDepol_532_V2] = pollyxt_lacros_quasiretrieve_V2(data, config)
%   Input:
%		data: struct
...
[quasi_par_bsc_355_V2, quasi_par_ext_355_V2] = quasi_retrieving_V2(data.height, att_beta_355, att_beta_387, 355, molExt355, molBsc355, molExt387, 0.0, 50, 3);
...
[quasi_par_bsc_532_V2, quasi_par_ext_532_V2] = quasi_retrieving_V2(data.height, att_beta_532, att_beta_607, 532, molExt532, molBsc532, molExt607, 0.0, 50, 3);
...
[quasi_par_bsc_1064_V2, quasi_par_ext_1064_V2] = quasi_retrieving_V2(data.height, att_beta_1064, att_beta_607, 1064, molExt1064, molBsc1064, molExt607, 0.0, 50, 3);
