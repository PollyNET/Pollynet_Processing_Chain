...
def pollyxt_lacros_display_WV(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_lacros_display_WV(tmpFile)
    ...
    ax.set_title('Water vapor mixing ratio from {instrument} at {location}'.format(instrument=pollyVersion, location=location), fontweight='bold', fontsize=14)
    ...
    ax.set_title('Relative humidity from {instrument} at {location}'.format(instrument=pollyVersion, location=location), fontweight='bold', fontsize=14)
...
def main():
    pollyxt_lacros_display_WV('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots\\POLLYXT_LACROS\\20180517')

if __name__ == '__main__':
    # main()
    pollyxt_lacros_display_WV(sys.argv[1], sys.argv[2])