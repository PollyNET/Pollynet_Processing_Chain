function [] = pollyxt_lacros_save_LC_txt(data, taskInfo, config)
%pollyxt_lacros_save_LC_txt  save the lidar constants
%   Example:
%       [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = pollyxt_lacros_save_LC_txt(data, taskInfo, config)
%   Inputs:
%       wvconst: array
