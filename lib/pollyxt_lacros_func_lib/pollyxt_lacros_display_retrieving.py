...
def pollyxt_lacros_display_retrieving(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_lacros_display_retrieving(tmpFile)
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_Bsc_Klett.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    p4, = ax.plot(aerBsc355_NR_klett * 1e6, height, color='#7842f5', linestyle='-', label='355 nm (NR)', zorder=4)
    p5, = ax.plot(aerBsc532_NR_klett * 1e6, height, color='#42f5b9', linestyle='-', label='532 nm (NR)', zorder=4)
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_NR_Bsc_Klett.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_Bsc_Raman.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    p4, = ax.plot(aerBsc355_NR_raman * 1e6, height, color='#7842f5', linestyle='-', label='355 nm (NR)', zorder=4)
    p5, = ax.plot(aerBsc532_NR_raman * 1e6, height, color='#42f5b9', linestyle='-', label='532 nm (NR)', zorder=4)
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_NR_Bsc_Raman.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_Bsc_Aeronet.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_Ext_Klett.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    
    # display near-range extinction with klett method
    fig = plt.figure(figsize=[4.5, 8])
    ax = fig.add_axes([0.20, 0.15, 0.75, 0.75])
    p1, = ax.plot(aerExt_355_klett * 1e6, height, color='#0000ff', linestyle='-', label='355 nm (FR)', zorder=2)
    p2, = ax.plot(aerExt_532_klett * 1e6, height, color='#00b300', linestyle='-', label='532 nm (FR)', zorder=2)
    p3, = ax.plot(aerExt_1064_klett * 1e6, height, color='#e60000', linestyle='-', label='1064 nm (FR)', zorder=3)
    p4, = ax.plot(aerExt355_NR_klett * 1e6, height, color='#7842f5', linestyle='-', label='355 nm (NR)', zorder=4)
    p5, = ax.plot(aerExt532_NR_klett * 1e6, height, color='#42f5b9', linestyle='-', label='532 nm (NR)', zorder=4)
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_NR_Ext_Klett.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_Ext_Raman.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    
    # display near-range extinction with raman method
    fig = plt.figure(figsize=[4.5, 8])
    ax = fig.add_axes([0.20, 0.15, 0.75, 0.75])
    p1, = ax.plot(aerExt_355_raman * 1e6, height, color='#0000ff', linestyle='-', label='355 nm (FR)', zorder=2)
    p2, = ax.plot(aerExt_532_raman * 1e6, height, color='#00b300', linestyle='-', label='532 nm (FR)', zorder=2)
    p3, = ax.plot(aerExt_1064_raman * 1e6, height, color='#e60000', linestyle='-', label='1064 nm (FR)', zorder=3)
    p4, = ax.plot(aerExt355_NR_raman * 1e6, height, color='#7842f5', linestyle='-', label='355 nm (NR)', zorder=4)
    p5, = ax.plot(aerExt532_NR_raman * 1e6, height, color='#42f5b9', linestyle='-', label='532 nm (NR)', zorder=4)
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_NR_Ext_Raman.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_Ext_Aeronet.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_LR_Raman.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    p3, = ax.plot(LR355_NR_raman, height, color='#7842f5', linestyle='-', label='355 nm (NR)', zorder=3)
    p4, = ax.plot(LR532_NR_raman, height, color='#42f5b9', linestyle='-', label='532 nm (NR)', zorder=2)
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_NR_LR_Raman.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()

    # display angstroem exponent with klett method
    fig = plt.figure(figsize=[4.5, 8])
    ax = fig.add_axes([0.20, 0.15, 0.75, 0.75])
    p1, = ax.plot(ang_bsc_355_532_klett, height, color='#ff8000', linestyle='-', label='BSC 355-532 (FR)', zorder=3)
    p2, = ax.plot(ang_bsc_532_1064_klett, height, color='#ff00ff', linestyle='-', label='BSC 532-1064 (FR)', zorder=3)
    p3, = ax.plot(ang_bsc_355_532_klett_NR, height, color='#ced812', linestyle='-', label='BSC 355_532 (NR)', zorder=2)
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_ANGEXP_Klett.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()

    # display angstroem exponent with raman method
    fig = plt.figure(figsize=[4.5, 8])
    ax = fig.add_axes([0.20, 0.15, 0.75, 0.75])
    p1, = ax.plot(ang_bsc_355_532_raman, height, color='#ff8000', linestyle='-', label='BSC 355-532 (FR)', zorder=3)
    p2, = ax.plot(ang_bsc_532_1064_raman, height, color='#ff00ff', linestyle='-', label='BSC 532-1064 (FR)', zorder=3)
    p3, = ax.plot(ang_ext_355_532_raman, height, color='#000000', linestyle='-', label='EXT 355-532 (FR)', zorder=3)
    p4, = ax.plot(ang_ext_355_532_raman_NR, height, color='#ced812', linestyle='-', label='EXT 355-532 (NR)', zorder=2)
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_ANGEXP_Raman.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_DepRatio_Klett.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_DepRatio_Raman.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_WVMR.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_RH.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_Meteor_T.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()
    ...
    fig.savefig(os.path.join(saveFolder, '{dataFilename}_{starttime}_{endtime}_Meteor_P.png'.format(dataFilename=rmext(dataFilename), starttime=datenum_to_datetime(starttime).strftime('%H%M'), endtime=datenum_to_datetime(endtime).strftime('%H%M'))), bbox_inches='tight', dpi=figDPI)
    plt.close()

def main():
    pollyxt_lacros_display_retrieving('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop\\Picasso\\recent_plots\\POLLYXT_LACROS\\20180517')

if __name__ == '__main__':
    # main()
    pollyxt_lacros_display_retrieving(sys.argv[1], sys.argv[2])