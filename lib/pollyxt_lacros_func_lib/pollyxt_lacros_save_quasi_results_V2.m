function [] = pollyxt_lacros_save_quasi_results_V2(data, taskInfo, config)
%pollyxt_lacros_save_quasi_results_V2 Saving the quasi retrieving results (V2) to netcdf file.
%   Example:
