...
def pollyxt_ift_display_att_beta(tmpFile, saveFolder):
    ...
    Usage
    -----
    pollyxt_ift_display_att_beta(tmpFile)
...
def main():
    pollyxt_ift_display_att_beta('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_ift_display_att_beta(sys.argv[1], sys.argv[2])