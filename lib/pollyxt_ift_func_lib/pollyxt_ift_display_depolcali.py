...
def pollyxt_ift_display_depolcali(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_ift_display_depolcali(tmpFile)
...
def main():
    pollyxt_ift_display_depolcali('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_ift_display_depolcali(sys.argv[1], sys.argv[2])