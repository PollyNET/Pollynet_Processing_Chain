...
def pollyxt_ift_display_monitor(tmpFile, saveFolder):
    ...
    shutter2 = (shutter2 == 31010000)   # Only care about status of '031010000'. In theory, there should be more status.
...
def main():
    pollyxt_ift_display_monitor('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')
