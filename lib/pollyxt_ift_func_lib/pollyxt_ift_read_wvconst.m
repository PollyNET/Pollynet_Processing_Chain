function [datetime, wvCaliFlag, wvconst, wvconstStd] = pollyxt_ift_read_wvconst(wvconstFile)
%pollyxt_ift_read_wvconst read the depolarization calibration results from the file.
%   Example:
%       [datetime, wvconst, wvconstStd] = pollyxt_ift_read_wvconst(wvconstFile)
%   Inputs:
%       wvconstFile: char
