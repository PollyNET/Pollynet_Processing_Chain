function [voldepol532_klett, pardepol532_klett, pardepolStd532_klett, voldepol532_raman, pardepol532_raman, pardepolStd532_raman, moldepol532, moldepolStd532, flagDefaultMoldepol532] = pollyxt_ift_depolratio(data, config)
%pollyxt_ift_depolratio retrieve volume depolarization ratio and particle depolarization ratio.
%   Example:
%       [voldepol532_klett, pardepol532_klett, pardepolStd532_klett, voldepol532_raman, pardepol532_raman, pardepolStd532_raman, moldepol532, moldepolStd532, flagDefaultMoldepol532] = pollyxt_ift_depolratio(data, config)
%   Inputs:
%       data.struct
