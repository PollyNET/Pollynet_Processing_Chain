function [quasi_par_bsc_355_V2, quasi_par_bsc_532_V2, quasi_par_bsc_1064_V2, quasi_par_depol_355_V2, volDepol_355, quasi_ang_532_1064_V2, quality_mask_355_V2, quality_mask_532_V2, quality_mask_1064_V2, quality_mask_volDepol_355_V2, quasiAttri_V2] = pollyxt_ift_quasiretrieve_V2_UV(data, config)
%POLLYXT_IFT_QUASIRETRIEVE_V2_UV Retrieving the intensive aerosol optical properties with Quasi-retrieving method. Detailed information can be found in doc/pollynet_processing_program.md
%Example:
%   [quasi_par_bsc_355_V2, quasi_par_bsc_532_V2, quasi_par_bsc_1064_V2, quasi_par_depol_355_V2, volDepol_532, quasi_ang_532_1064, quality_mask_355_V2, quality_mask_532_V2, quality_mask_1064_V2, quality_mask_volDepol_355_V2] = pollyxt_ift_quasiretrieve_V2_UV(data, config)
%Input:
%   data.struct
...
quasi_par_depol_355_V2 = (volDepol_355_smooth + 1) ./ (molBsc355 .* (defaults.molDepol355 - volDepol_355_smooth) ./ (quasi_par_bsc_355_V2 .* (1 + defaults.molDepol355)) + 1) - 1;
quasi_par_depol_355_V2((quality_mask_volDepol_355_V2 ~= 0) | (quality_mask_355 ~= 0)) = NaN;
