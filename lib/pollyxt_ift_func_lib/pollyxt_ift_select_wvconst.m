function [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = pollyxt_ift_select_wvconst(wvconst, wvconstStd, IWVAttri, currentTime, file, flagUsePreviousWVConst)
%pollyxt_liftselect_wvconst  select the most appropriate water vapor 
%calibration constant to calculate the WVMR and RH.
%   Example:
%       [wvconstUsed, wvconstUsedStd, wvconstUsedInfo] = 
%           pollyxt_liftselect_wvconst(wvconst, wvconstStd, WVCaliInfo, 
...
if isempty(wvconst)
    [wvconstUsed, wvconstUsedStd] = pollyxt_ift_search_wvconst(currentTime, ...
