...
def pollyxt_ift_display_longterm_cali_UV(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_ift_display_longterm_cali_UV(tmpFile)
...
def main():
    pollyxt_ift_display_longterm_cali_UV(
        'D:\\coding\\matlab\\pollynet_Processing_Chain\\tmp.mat',
        'C:\\Users\\zpyin\\Desktop\\')


if __name__ == '__main__':
    # main()
    pollyxt_ift_display_longterm_cali_UV(sys.argv[1], sys.argv[2])
