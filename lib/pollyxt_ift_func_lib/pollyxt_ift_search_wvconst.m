function [wvconst, wvconstStd] = pollyxt_ift_search_wvconst(currentTime, ...
                                file, deltaTime, defaults, flagUsePrevWVConst)
%pollyxt_ift_search_wvconst Search the previous calibration constants with 
%a time lag less than deltaTime.
%   Example:
%       [wvconst, wvconstStd] = pollyxt_ift_search_wvconst(currentTime, file,
...
[preWVlCaliTime, preWVCaliFlag, preWVconst, preWVconstStd] = pollyxt_ift_read_wvconst(file);
