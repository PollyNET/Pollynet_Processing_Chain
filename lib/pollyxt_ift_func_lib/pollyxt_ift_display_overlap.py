...
def pollyxt_ift_display_overlap(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_ift_display_overlap(tmpFile)
...
def main():
    pollyxt_ift_display_overlap('C:\\Users\\zhenping\\Desktop\\Picasso\\tmp\\tmp.mat', 'C:\\Users\\zhenping\\Desktop')

if __name__ == '__main__':
    # main()
    pollyxt_ift_display_overlap(sys.argv[1], sys.argv[2])