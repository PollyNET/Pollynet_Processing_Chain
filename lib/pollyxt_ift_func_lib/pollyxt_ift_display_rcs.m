function [] = pollyxt_ift_display_rcs(data, taskInfo, config)
%pollyxt_ift_display_rcs display the range corrected signal, vol-depol at 355 and 532 nm
%   Example:
%       [] = pollyxt_ift_display_rcs(data, config)
%   Inputs:
%       data.struct
...
elseif strcmpi(processInfo.visualizationMode, 'python')
    ...
    RCS_NR_532 = RCS_FR_532;
    RCS_NR_355 = RCS_FR_355;
    ...
    save(tmpFile, 'figDPI', 'mTime', 'height', 'depCalMask', 'fogMask', 'yLim_FR', 'yLim_NR', 'RCS_FR_355', 'RCS_FR_532', 'RCS_FR_1064', 'RCS_NR_355', 'RCS_NR_532', 'volDepol_532', 'processInfo', 'campaignInfo', 'taskInfo', 'xtick', 'xtickstr', 'RCS355FRColorRange', 'RCS532FRColorRange', 'RCS1064FRColorRange', 'RCS355NRColorRange', 'RCS532NRColorRange', '-v7');
