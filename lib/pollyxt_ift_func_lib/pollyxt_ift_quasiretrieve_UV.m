function [quasi_par_bsc_355, quasi_par_bsc_532, quasi_par_bsc_1064, quasi_par_depol_355, volDepol_355, quasi_ang_532_1064, quality_mask_355, quality_mask_532, quality_mask_1064, quality_mask_volDepol_355, quasiAttri] = pollyxt_ift_quasiretrieve_UV(data, config)
%POLLYXT_IFT_QUASIRETRIEVE_UV Retrieving the intensive aerosol optical properties with Quasi-retrieving method. Detailed information can be found in doc/pollynet_processing_program.md
%Example:
%   [quasi_par_bsc_355, quasi_par_bsc_532, quasi_par_bsc_1064, quasi_par_depol_355, volDepol_355, quasi_ang_532_1064, quality_mask_355, quality_mask_532, quality_mask_1064, quality_mask_volDepol_355] = pollyxt_ift_quasiretrieve_UV(data, config)
%Inputs:
%   data.struct
...
%% calculate volDepol 355 and 355 nm
...
quasi_par_depol_355 = (volDepol_355_smooth + 1) ./ (molBsc355 .* (defaults.molDepol355 - volDepol_355_smooth) ./ (quasi_par_bsc_355 .* (1 + defaults.molDepol355)) + 1) - 1;
quasi_par_depol_355((quality_mask_volDepol_355 ~= 0) | (quality_mask_355 ~= 0)) = NaN;
