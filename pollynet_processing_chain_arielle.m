...
[data.wvconstUsed, data.wvconstUsedStd, data.wvconstUsedInfo] = arielle_select_wvconst(wvconst, wvconstStd, wvCaliInfo, data.IWVAttri, polly_parsetime(taskInfo.dataFilename, config.dataFileFormat), defaults, fullfile(processInfo.results_folder, campaignInfo.name, config.wvCaliFile));
...
if processInfo.flagEnableResultsOutput
    ...
    arielle_save_wvconst(wvconst, wvconstStd, wvCaliInfo, data.IWVAttri, taskInfo.dataFilename, defaults, fullfile(processInfo.results_folder, campaignInfo.name, config.wvCaliFile));
