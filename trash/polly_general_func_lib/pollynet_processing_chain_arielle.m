function [report] = pollynet_processing_chain_arielle()
% POLLYNET_PROCESSING_CHAIN_ARIELLE main processing functions for arielle data.
% USAGE:
%    [report] = pollynet_processing_chain_arielle
% OUTPUTS:
%   report: cell array
%       information about each figure.
% EXAMPLE:
% HISTORY:
%    2021-04-09: first edition by Zhenping
...
fprintf(['\n[%s] Start to retrieve high sppatial-temporal resolved ', ...
