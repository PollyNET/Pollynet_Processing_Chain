function LCUsed = pollyxt_ift_select_liconst(data, config, dbFile)
%POLLYXT_IFT_SELECT_LICONST select the most suitable lidar calibration constants.
%Example:
%   LCUsed = pollyxt_ift_select_liconst(data, config, dbFile)
%Inputs:
%   data.struct
