function [aerBsc355_raman, aerBsc532_raman, aerBsc1064_raman, aerExt355_raman, aerExt532_raman, aerExt1064_raman, LR355_raman, LR532_raman, LR1064_raman] = pollyxt_ift_raman_UV(data, config)
%POLLYXT_IFT_RAMAN_UV Retrieve aerosol optical properties with raman method
%Example:
%   [aerBsc355_raman, aerBsc532_raman, aerBsc1064_raman, aerExt355_raman, aerExt532_raman, aerExt1064_raman, aerLR355_raman, aerLR532_raman, aerLR1064_raman] = pollyxt_ift_raman_UV(data, config)
%Inputs:
%   data.struct
...
for iGroup = 1:size(data.cloudFreeGroups, 1)
    ...
    sig532 = squeeze(sum(data.signal(flagChannel532, :, proIndx_607On), 3));
    bg532 = squeeze(sum(data.bg(flagChannel532, :, proIndx_607On), 3));
