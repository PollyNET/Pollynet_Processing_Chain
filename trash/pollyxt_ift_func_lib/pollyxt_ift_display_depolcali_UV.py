...
def pollyxt_ift_display_depolcali_UV(tmpFile, saveFolder):
    """
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_ift_display_depolcali_UV(tmpFile, saveFolder)
...
def main():
    pollyxt_ift_display_depolcali_UV(
...
if __name__ == '__main__':
    # main()
    pollyxt_ift_display_depolcali_UV(sys.argv[1], sys.argv[2])
