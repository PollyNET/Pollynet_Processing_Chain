function [tc_mask] = pollyxt_ift_targetclassi(data, config)
%POLLYXT_IFT_TARGETCLASSI Aerosol target classification based on algorithms presented in H.Baar et al, 2017, AMT.
%Example:
