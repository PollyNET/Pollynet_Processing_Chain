...
def pollyxt_cge_display_longterm_cali(tmpFile, saveFolder):
    '''
    Description
    -----------
    ...
    Usage
    -----
    pollyxt_cge_display_longterm_cali(tmpFile)
    ...
    LCTime1064 = [
        LCTime1064[indx]
        for indx in np.arange(0, len(LCTime1064)) if LC1064Status[indx] == 2]
    p1 = ax3.scatter(
...
def main():
    pollyxt_cge_display_longterm_cali(
...
if __name__ == '__main__':
    # main()
    pollyxt_cge_display_longterm_cali(sys.argv[1], sys.argv[2])
